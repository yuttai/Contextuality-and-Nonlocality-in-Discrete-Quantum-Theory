...
theorems respectively exclude any non-local and non-contextuality
deterministic hidden variable model, Meyer claimed that finite-precision
measurements invalidate the spirit of the Kochen-Specker theorem~\cite{PhysRevLett.83.3751},
i.e., quantum theory with finite-precision measurements might be non-contextual.
In our investigation~\cite{THOS2018}, we employ an interval-valued
...
physical measurements are precise enough, the Kochen-Specker theorem
remains valid, i.e., quantum theory remains contextual. Hence, our
