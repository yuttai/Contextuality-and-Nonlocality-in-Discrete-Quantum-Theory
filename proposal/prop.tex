...
the probability measure. But surely the less resources are availble,
...
\paragraph*{Research Question.} confirm that we get closer and closer
to Born rule as precision improves; find conditions on interval-valued
quantum prob. measures that would make sense; precision improves
implies states get sharper
