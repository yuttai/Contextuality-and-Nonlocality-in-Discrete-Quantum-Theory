...
as~\cite{peres1995quantum,544199,Jaeger2007}
...
\item For a set of mutually orthogonal projections
  ...
  $\bar{\mu}\left(\sideset{}{_{i=1}^{N}}\sum
    P_{i}\right)\subseteq\sideset{}{_{i=1}^{N}}\sum\bar{\mu}\left(P_{i}\right)$.
\end{itemize}
\end{definition}
...
\begin{figure}
\begin{center}
\includegraphics[scale=0.48]{measure4.pdf}
\end{center}
...
\begin{figure}
\begin{center}
  \includegraphics[scale=0.48]{HoughLineData.pdf}
\end{center}
...
to computer even one general real number.  Thus the combination of
...
courses on ``Quantum Computing'' for graduate students.  These courses
were highly appreciated by the students as noted by their evaluations
in making the material extremely accessible and interesting.  The PIs
plan to engage high school students or undergraduates in the
implementation of some of the ideas.  The PIs have a long standing
commitment to K-12 science and math education (see also (C)
below). The collaborative group efforts will provide students, as well
as the PIs with a unique learning experience. The broadened
...
prepare students and postdocs for productive careers in an
...
Dr. Ortiz. In the past five years, Prof. Sabry received one NSF grant
...
(1) Computing with Semirings and Weak Rig Groupoids, European
Symposium on Programming, 2016, (2) Superstructural Reversible Logic,
International Workshop on Linearity, 2014, (3) Theseus: A High Level
Language for Reversible Computing. Work-in-Progress report in the
Conference on Reversible Computation, 2014, (4) Discrete Quantum
Theories, J. Phys. A: Math. Theor. 2014., (5) Geometry of Discrete
Quantum Computing, J. Phys. A: Math. Theor. 2013., (6) Isomorphic
Interpreters from Logically Reversible Abstract Machines. Workshop on
Reversible Computation 2012. On the applications side, we have the
following papers: (1) Copredication in Homotopy Type Theory: A
homotopical approach for formal semantics of natural
languages. Workshop on Natural Language and Computer Science, 2016.,
(2) Contract Monitoring Semantics as Patterns of
Communication. International Conference on Functional Programming,
2015., (3) Extensible Effects: An Alternative to Monad
Transformers. Haskell Symposium, 2013., (4) Encoding Secure
