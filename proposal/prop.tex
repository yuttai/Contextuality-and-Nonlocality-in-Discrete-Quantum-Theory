...
\begin{itemize}
\item Computing with Semirings and Weak Rig Groupoids, European
  Symposium on Programming, 2016.
\item Superstructural Reversible Logic, International Workshop on
  Linearity, 2014.
\item Theseus: A High Level Language for Reversible
  Computing. Work-in-Progress report in the Conference on Reversible
  Computation, 2014.
...
\item Isomorphic Interpreters from Logically Reversible Abstract
  Machines. Workshop on Reversible Computation 2012.
\end{itemize}
