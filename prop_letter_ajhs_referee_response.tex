...
condition. Recall that convexity condition for a QIVPM
$\mu : \events \rightarrow \mathscr{I}$ states that for each pair of
...
\[\begin{array}{rcl}
&& \bar{\mu}\left(P+P'-PP'\right)+\bar{\mu}\left(PP'\right) \\
&& \hfill(\mbox{because } P = PP' + P - PP') \\
...
In case the uncertain data reaches $\frac{1}{3}$, the probability measure
...
have a \emph{common point}. And hence by assuming that the uncertain data for
