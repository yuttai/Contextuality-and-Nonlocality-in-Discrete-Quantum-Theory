...
all possible distinct one-qubit quantum states. 
\begin{figure}[tbh]
...
\end{figure}
In Fig.~\ref{hopfFibers.fig}, we illustrate schematically the family
of circles \textit{each one of which is collapsed to a point\/} $(\theta,\phi)$
on the surface $X^{2}+Y^{2}+Z^{2}=1$ by the Hopf map.
