...
\end{doublespace}
\end{sidewaystable}
I want to thank the professors served in all my committees. These
...
quantum theories. I would like to express my appreciation to all of
these.
...
dissertation, I must thank for your teaching to make me more mature
...
is cited in Secs.~\ref{CQC1qubitBloch.sec}, \ref{sec:background},
...
Many people have done everything to make my double-major smooth. Moreover,

and to financially or specially support me during my \PhD study.
A comprehensive list is in my Curriculum Vitae at the end of the dissertation.
I need to thank all of them. Most importantly, Prof.\ Amr A. Sabry\ (\textarabic{عمرو صبري})
...
me to compose this dissertation or to do research in general, and
...
Chinese names to the same English name, so we lose some precision
or information if we only record their English name.}
...
is in which measurement basis. The measurement bases only matters
we want to simulate the prediction of CQT by a classical hidden variable
theory. In this situation, the hidden variable theory is called \emph{contextual}.
...
to two cardinal probabilities with different ``denominator''. The
