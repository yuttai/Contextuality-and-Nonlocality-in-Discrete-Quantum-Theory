...
and~\ref{sec:Toward-IVPM}. Besides of my committee members, the
knowledge I learned from teachers in other courses help me consolidate
...
\begin{table}[t]
\begin{doublespace}
\noindent \centering{}\caption{\label{tab:teacher}The knowledge I learned from teachers in other
...
Ergun}; the infrastructure and technology group (ITG). In particular,
...
Technology Services (UITS). Also, I have checked out a stack of books
from the Indiana University Libraries. While the books are not in
the collection, I occasionally requested them via the Interlibrary
Loan service, submitted the Purchase Recommendation Form to suggested
IU libraries to buy them.\todo{Acknowledgments cleaned up until here.
}

Except the financial support via employment and award, I have also
support by my family, especially my father Cheng-Tien Tai (戴振沺).
