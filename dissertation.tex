...
“thank”, and looks boring. To improve my Acknowledgments, I
briefly read the Acknowledgments in other theses \cite{Chih2013,Sun2015,Lee2013,Chen2016,sabry1995formal}.
\end{comment}
\begin{acknowledgments*}
\begin{sidewaystable}
\noindent \begin{centering}
\caption{\label{tab:acknowledgments}I want to thank the professors co-authored
with me, suggested me as a committee member, and taught me, and the
collaboration or supervised works or studies become the basis of or
inspire this dissertation.}
\par\end{centering}
\noindent \centering{}\noindent \centering{}%
\begin{tabularx}{\linewidth}{M{MATH-M781}M{Co-author}M{(\textarabic{عمرو صبري})}M{Co-author}M{Thurston}M{Shouhong}M{Lawrence}Y}
\toprule 
\addlinespace
Committee or course & Gerardo Ortiz & Amr\nolinebreak[3] A. Sabry\linebreak[3] (\textarabic{عمرو صبري}) & Andrew\nolinebreak[3] J. Hanson & Dylan\nolinebreak[3] Paul Thurston & Shouhong Wang\linebreak[3] (汪守宏) & Lawrence\nolinebreak[3] S.\linebreak[2] Moss & Relation with the dissertation\tabularnewline\addlinespace
\addlinespace
\midrule
\midrule 
\addlinespace
 & Co-author & Co-author & Co-author &  &  &  & Most of Chapters~\ref{chap:Conventional-Quantum-Theory}, \ref{chap:Unrestricted-Finite-Fields},
and~\ref{chap:DQT=000026DQC} is based on \cite{geometry2013} and \cite{DQT2014}; most of Chapter~\ref{chap:QIVPM} is
based on \cite{THOS2018}.\tabularnewline\addlinespace
\addlinespace
\midrule
\addlinespace
...
and some of the remaining ones are explained in Chapter~\ref{chap:Further-Discussion}.\tabularnewline\addlinespace
\addlinespace
\midrule
\addlinespace
 &  & Suggested &  &  &  &  & The application for Rethinking Foundations of Physics 2017 workshop
inspires Chapter~\ref{chap:Introduction}.\tabularnewline\addlinespace
\addlinespace
\midrule
\addlinespace
Advisory committee & Member & Member & Member & Member &  &  & The survey of real computation in the Computer Science qualifying
exam (chaired by Prof.\ Sabry) inspires Chapter~\ref{chap:Introduction}.\tabularnewline\addlinespace
\addlinespace
\midrule
\addlinespace
PHYS-P700 & Instructor &  &  &  &  &  & The textbook~\cite{Mermin2007} is
cited in Chapters~\ref{chap:Introduction}, \ref{chap:Conventional-Quantum-Theory},
\ref{chap:DQT=000026DQC}, and~\ref{chap:QIVPM}.\tabularnewline\addlinespace
\addlinespace
\midrule
\addlinespace
MATH-M781 &  &  &  &  &  & Instructor & The presented paper~\cite{Abramsky2012} is cited in Sec.~\ref{subsec:Classical-and-Quantum}.\tabularnewline\addlinespace
\addlinespace
\midrule
\addlinespace
Tier 3 committee & Co-chair & Co-chair &  & Member &  & Co-chair & Two of
the assigned papers in the Tier 3 exam, \cite{Schumacher2012-SCHMQT}
and \cite{doi:10.1142/S0217984913500644},
are cited in Sec.~\ref{modalquantum}.\tabularnewline\addlinespace
\addlinespace
\bottomrule
\end{tabularx}
\end{sidewaystable}
I want to thanks all my professors co-authored with me, suggested
me as a committee members, and taught me which become the bases or
inspired any part of my dissertation as listed in Table~\ref{tab:acknowledgments}.
Especially, Prof.\ Gerardo Ortiz, Prof.\ Amr A. Sabry\ (\textarabic{عمرو صبري}),
and Prof.\ Andrew J. Hanson meet me weekly for the pass few years,
read and tried to understand what I typed which sometimes even myself
cannot understand, taught me how to organize them in ``English''
so that general audience might be interested and have some chance
to understand, and encourage me to participate seminars, workshops,
and conferences. Prof.\ Lawrence Moss invited me to present our results
in the interdisciplinary logic seminar and theory seminar in Computer
Science and wrote an assessment letter for me. Although not directly
related to this dissertation, the knot theory studied with Prof.\ Dylan
Paul Thurston and the quantum interpretation discussed with Prof.\ Shouhong
Wang (汪守宏) also broadened my understanding on quantum theory and computing.
I would like express my appreciation to all of these.

Besides of Table~\ref{tab:acknowledgments}, I have some inspiring
discussion with John Gardiner about quantum probability measures over
finite fields~\cite{Gardiner2014}, and his results are improved
and motivated the transition from DQT to QIVPM in Sec.~\ref{sec:Toward-IVPM}.
Also, some unpublished computation for deterministic quantum algorithms
is organized in the term paper for SLST-T501 Academic Writing course.
I want to thank Prof.\ Tom Lewis for proof-reading them, and they
become the bases of Sec.~\ref{subsec:Discrete-Deutsch-algorithm}.
Besides of Prof.\ Tom Lewis, my other English teachers, especially
Traci Nagle, Elizabeth ``Betsy'' Merceron, and Kexin ``Casey''
Chen (谌可心), taught me a lot on expressing myself in English as well.
Others who help me indirectly on the content of dissertation including
Kin Wai Chan, Prof.\ 朱樺, Weihua Liu (刘伟华), 劉鈺平, Meng-Wei Chen
(陳孟瑋), \ldots , etc. This could be listed on and on, and I still
thank you even if your name is not listed here.\todo{Acknowledgments
cleaned up until here. }

Many people in both departments of Mathematics and Computer Science
need to do something more to make my double-major works smoothly.
I need to thank all of them, especially directors of graduate study
in Mathematics, especially Prof.\ Christopher Judge and Prof.\ Matthias
Weber; directors of Ph.D. study in Computer Science, especially Prof.\ Yuqing
Melanie Wu (吴愈青) and Prof.\ \textturkish{Funda Ergun}.
...
Chen (谌可心), Yao-yu Chih (池耀宇), and Xinyi ``Diana'' Gong (龚欣怡), for
you always pay our telephone bill on time so that\ldots\ldots\todo{
Maybe I don't have to thank them as AT\&T family plan members, but
I should thank some of them for support and sharing information\ldots}
...
better capture our ability to predict quantum phenomenon and the power
...
Reliably & 
Not reliably, but after we have better technology to manipulate the minimum units, we can more reliably predict the physical phenomenon and their computational power by a better discrete model. & 
...
``imprecise probability'' has well-studied classically \cite{Shafer1976,GilboaSchmeidler1994,Marinacci1999,JamisonLodwick2004,HuberRonchetti2009,Grabisch2016}.
\begin{comment}
...
quantum theory over finite fields based on the following definition.
