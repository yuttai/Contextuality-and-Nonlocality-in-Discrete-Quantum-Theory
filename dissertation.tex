...
mapping to intervals bounded by $\varepsilon$ always have non-empty
cores.
...
\todo{Check the differential geometry analog with Andy, since I don't
really understand the differential geometry\ldots{} }This is like
...
probability amplitudes instead of the measured probability, either
a quantum computing model above QIVPMs needs to manipulate the states
in the core of a QIVPM, or we need to find a way to manipulate QIVPMs
directly. However, both strategies are not straightforward. On one
hand, as we proved in Thm.~\ref{thm:Non-extensible-of-Gleason's},
