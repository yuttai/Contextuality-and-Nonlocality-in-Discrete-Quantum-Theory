...
constraints. When $E$ contains no outcome, $E$ is the least likely
to happen, i.e., $\mu\left(\emptyset\right)=0$. When $E$ contains
all outcomes, $E$ is the most likely to happen, i.e., $\mu\left(\Omega\right)=1$.
If we know the likelihood of an event, $\mu\left(E\right)$, it is
natural to assume the likelihood of the event’s complement is just
the opposite of $\mu\left(E\right)$, i.e., $\mu\left(\overline{E}\right)=1-\mu\left(E\right)$.
