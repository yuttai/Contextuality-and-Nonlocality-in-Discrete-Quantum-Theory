...
precision measurement. }For example, Blum, Cucker, Shub, and Smale
modeled their machine to allow the operations of deciding whether
a number is greater or equal to zero over real numbers and whether
a number is exactly zero over complex numbers \cite{BSS1989,Ziegler2007,blum2012complexity}.
Since no physical analog computer could branch in these operations
based on a few significant figures, the theoretical prediction of
Blum-Cucker-Shub-Smale (BCSS) machine cannot fully apply on physical
devices.
