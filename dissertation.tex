...
Thurston and Prof.~Shouhong Wang (汪守宏), they getting together to
understand my dissertation proposal and dissertation, and all the
suggestions are extremely helpful, where the proposal provides the
framework of the dissertation. Some proposed questions are solved
in Chapter~\ref{chap:QIVPM}, and some of the remaining questions
is explained in Chapter~\ref{chap:Further-Discussion}. \todo{Acknowledgments
cleaned up until here. }Also thank Prof.\ Dylan Thurston for serving
...
exam inspired me the comparison of quantum computer and analog computer
in Chapter~\ref{chap:Introduction}. Chapter~\ref{chap:Introduction}
...
effect. Therefore, we might not be able to utilize the realistic analog
computers to acquire the computational power predicted by this kind
...
\end{comment}
This idea will be extended to the quantum domain as quantum interval-valued
