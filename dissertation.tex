...
\toprule 
\addlinespace
Physical quantities & Discrete & Discrete with extreme small unit & Continuous, but unlikely to verify they really are\tabularnewline\addlinespace
\addlinespace
\addlinespace
...
theory, we assume the probability of an event

, and consider a framework called quantum interval-valued probability
