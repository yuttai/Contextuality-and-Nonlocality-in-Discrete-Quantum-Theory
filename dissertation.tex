...
Even before quantum mechanics is discovered, human tried to characterize
the physical quantities and manipulate them to simulate and predict
unknown quantities. Discrete quantities can be easily characterized
by whole numbers~\cite{ParkerBaldridge2004}. Even if the proportion
of whole numbers are fractions, the operations among fractions is
essentially the same as those among whole numbers over the common
denominator, and the computational results faithfully represent the
corresponding quantities. In general, discrete computation can be
reliably repeated with exact equivalence, and any digital computer
...
\begin{tabular}{c}
\noalign{\vskip\doublerulesep}
Likelihood of\tabularnewline[\doublerulesep]
\noalign{\vskip\doublerulesep}
\noalign{\vskip\doublerulesep}
Events is\tabularnewline[\doublerulesep]
\noalign{\vskip\doublerulesep}
\noalign{\vskip\doublerulesep}
...
\begin{tabular}{c}
\noalign{\vskip\doublerulesep}
Yes when Measurement\tabularnewline[\doublerulesep]
\noalign{\vskip\doublerulesep}
\noalign{\vskip\doublerulesep}
