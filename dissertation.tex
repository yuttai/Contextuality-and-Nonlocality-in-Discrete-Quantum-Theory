...
\begin{comment}
\todo{Confirm people to be acknowledged like the way being acknowledged\ldots{}
}
\end{comment}
I want to thank Prof.~Gerardo Ortiz, Prof.~Amr Sabry (\textarabic{عمرو صبري}),
and Prof.~Andrew Hanson for publishing three papers \cite{geometry2013,DQT2014,THOS2018}
with me, and enormous other things. These papers become the main part
of my thesis, especially most of Chapter~\ref{chap:Conventional-Quantum-Theory},
...
and ``Discrete quantum theories''~\cite{DQT2014}; most of Chapter~\ref{chap:QIVPM}
is based on ``Quantum Interval-Valued Probability: Contextuality
and the Born Rule''~\cite{THOS2018}. Together with Prof.~Dylan
Thurston and Prof.~Shouhong Wang (汪守宏), you provide helpful suggestions
for my dissertation proposal and dissertation itself, where the proposal
provides the framework of the dissertation. Some proposed questions
are solved in Chapter~\ref{chap:QIVPM}, and some of the remaining
questions are explained in Chapter~\ref{chap:Further-Discussion}.
While being completely rewritten, the idea of Chapter~\ref{chap:Introduction}
comes from my application for Rethinking Foundations of Physics 2017
workshop reviewed by Prof.\ Amr Sabry~(\textarabic{عمرو صبري})
and my survey of real computation in my Computer Science qualifying
exam with my advisory committee, Prof.~Amr Sabry(\textarabic{عمرو صبري}),
Prof.~Gerardo Ortiz, and Prof.~Andrew Hanson, and Prof.\ Dylan
Thurston. My study for Tier 3 exam, which is part of the qualifying
exam for Mathematics, is also helpful when I start to export the work
of quantum computing, and \todo{Acknowledgments cleaned up until
here. }Also thank Prof.\ Dylan Thurston for serving in my advisory
...
reviewed by Prof.\ Amr Sabry~(\textarabic{عمرو صبري}). I
want to thank Prof.\ Lawrence Moss for inviting me to present our
