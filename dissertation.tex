...
\begin{acknowledgments}Thank Prof. Andrew J. Hanson, Prof. Gerardo
Ortiz, and Prof. Amr A. Sabry for publishing three papers \cite{geometry2013,DQT2014,THOS2017}
...
and the Born Rule'' \cite{THOS2017}. Together with Prof. Dylan Paul
Thurston and Prof. Shouhong Wang, thank you for getting together to
understand what I did and passing my dissertation proposal Spring
2017. Also, you passed my Computer Science qualified exam Spring 2016.
Especially, my survey of real computation inspires me the comparison
...
my Tier 3 committee, and drawing my attention on Prof. Abramsky's
paper~\cite{Abramsky2012}, which inspired me to merge quantum probability
with discrete quantum theories. Thanks John Gardiner for inspiring
discussion on the difficulties merging quantum probability with discrete
quantum theories~\cite{Gardiner2014}. An improved work consists
of Sec.~\ref{sec:Toward-IVPM} \end{acknowledgments}
\begin{abstract}
