...
\caption{\label{tab:committee}I want to thank the professors co-authored with
me, suggested me as a committee member, and taught me; the collaboration
or supervised works or studies become the basis of or inspire this
dissertation.}
\par\end{centering}
\noindent \centering{}\noindent \centering{}%
...
\end{tabularx}
\end{sidewaystable}
I want to thanks the professors served in all my committees. These
...
\begin{sidewaystable}
\noindent \begin{centering}
\caption{\label{tab:teacher}The knowledge I learned from teachers in other
courses help me consolidate this dissertation, where IUB stands for
Indiana University Bloomington and NTU stands for National Taiwan
University.}
\par\end{centering}
%% ERT block 1 (before LyX tabular)
\renewcommand{\tabular}{\tabularx{\linewidth}}
\renewcommand{\endtabular}{\endtabularx} 
\begin{tabular}{ccM{MATH-M522}M{English~for~International~Graduate~Students:}Y}
\toprule 
\addlinespace
Instructor & School & Course & Title & Relation with the dissertation\tabularnewline\addlinespace
\midrule
\midrule 
\addlinespace
Tom Lewis & IUB & SLST-T501 & English for International Graduate Students:\linebreak[3] Academic
Writing & Sec.~\ref{subsec:Discrete-Deutsch-algorithm} is based on the term
paper.\tabularnewline\addlinespace
\midrule 
\addlinespace
Michael A. Mandell & IUB & MATH-M522 & Topology II & The textbook~\cite{Hatcher2001} is cited in Chapters~\ref{chap:Introduction}
and~\ref{chap:Conventional-Quantum-Theory}.\tabularnewline\addlinespace
\midrule 
\addlinespace
Steven Myers & IUB & CSCI-B502 & Computational Complexity & The textbook~\cite{AroraBarak2009} is cited in Sec.~\ref{modalquantumcomputing}.\tabularnewline\addlinespace
\midrule 
\addlinespace
Valery Lunts & IUB & MATH-M501 & Survey of Algebra & The textbook~\cite{DummitFoote2004} is cited in Sec.~\ref{sec:background},
\ref{discretequantumtheoryI}, and~\ref{sec:Discrete-Quantum-Theory-(II)}.\tabularnewline\addlinespace
\midrule 
\addlinespace
Huah Chu (朱樺\textenglish[variant=american]{)} & NTU & 221~U3830\linebreak[3] 221~U3840 & Algebra(I)\linebreak[3] Algebra(II) & The textbook~\cite{Artin1991} is cited in Sec.~\ref{CQC1qubitBloch.sec},
\ref{sec:background}, \ref{discretequantumtheoryI}, and~\ref{sec:Discrete-Quantum-Theory-(II)}.\tabularnewline\addlinespace
\midrule
\addlinespace
Jin-Tzu Chen (陳金次) & NTU & 201~31300 & Functions of a Complex Variable & The textbook~\cite{GAMELIN2003} is cited in Sec.~\ref{subsec:Vector-Spaces}.\tabularnewline\addlinespace
\bottomrule
...
in Sec.~\ref{sec:Toward-IVPM}. Besides of my committee members,
the knowledge I learned from teachers in other courses help me consolidate
this dissertation as listed in Table~\ref{tab:teacher}. Although
not directly relating to the dissertation, I have to thank for your
teaching to make me more mature and easier to communicate with others,
especially my English teachers, Traci Nagle, Elizabeth ``Betsy''
...
Prof.\ Matthias Weber, and Prof.\ Michael A.\ Mandell; directors
of Ph.D. study in Computer Science, especially Prof.\ Yuqing Melanie
Wu (吴愈青) and Prof.\ \textturkish{Funda Ergun}.

Others who help me indirectly on the content of the dissertation including
Kin Wai Chan, Weihua Liu (刘伟华), Caren Liu (劉鈺平), Meng-Wei Chen
(陳孟瑋), Hao-Chun Lee (李浩君), Chao-Hong Chen (陳昭宏)\ldots , etc. This
could be listed on and on. I still thank you even if your name is
not listed here, and sorry for my bad memory.
...
\toprule 
\addlinespace
$x$ & $f_{1}\left(x\right)$ & $f_{2}\left(x\right)$ & $f_{3}\left(x\right)$ & $f_{4}\left(x\right)$\tabularnewline\addlinespace
\midrule
\addlinespace
\addlinespace
...
uninterrupted sequence $S_{2}\left(5\right)=\left\{ 0,1,2,3,4\right\} $,
...
Although cardinal probabilities can be ordered as discussed in \ref{discretequantumtheoryIIb},
...
Following the similar computation to the previous paragraph, we now
...
sense that a restriction of QIVPMs to mutually commuting subspace
of events, $\eventsC$, recovers the definition of classical IVPMs.
 To see this, we first define the idea of subspace of events. $\events'$
is called a \emph{subspace} of the set of events~$\events$ if $\events'$
...
of the projectors formed by elements in $E$, and preserve all operations
used to defined classical and quantum IVPMs as in Eqs.~(\ref{eq:pullback-properties-basic})
...
These ``true'' probabilities can be represented as a probability
...
Notice that right-most side of Eq.~(\ref{eq:pullback-real-measures})
...
orthonormal basis $\Omega=\{\ket{0},\ket{1},\ldots,\ket{D-1}\}$,
