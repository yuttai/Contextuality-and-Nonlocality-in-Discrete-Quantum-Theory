...
as the classical event space, a classical probability measure $\mu:2^{\Omega}\rightarrow\left[0,1\right]$
...
\todo{Further discussion clean up until here.} Almost all QIVPMs
