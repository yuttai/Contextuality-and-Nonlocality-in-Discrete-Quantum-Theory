...
and \ref{chap:DQT=000026DQC}. Alternatively, that the probability
amplitudes could never be quantized no matter how hard we try. Notice
that the probability amplitudes is unlikely to be accessed directly
while the probability of an event can be easily deduced after a series
of experiments. To achieve a coherent formulation of finite-resource
quantum mechanics, we extend classical interval-valued probability
measures to quantum domain, and consider quantum interval-valued probability
