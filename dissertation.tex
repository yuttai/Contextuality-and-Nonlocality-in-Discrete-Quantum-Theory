...
of the observable $\mathbf{O}_{0}$ with with spectral decomposition
\begin{equation}
...
we use a different beam splitter corresponding to the observable $\mathbf{O}_{1}$
...
to define contextuality which will be explained later in Sec.~\ref{sec:Kochen-Specker}.
...
its quantum event as the projector generated by $E$
\begin{equation}
...
Hilbert space, because of the following lemma.
