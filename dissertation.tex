...
\midrule
\addlinespace
 &  & Supervisor &  &  &  &  & The application for ``Rethinking Foundations of Physics'' 2017 workshop
...
me as a committee members, and taught me so that our work or studies
became the bases or inspired any part of my dissertation as listed
in Table~\ref{tab:acknowledgments}. Especially, Prof.\ Andrew J.
Hanson, Prof.\ Gerardo Ortiz, and Prof.\ Amr A. Sabry\ (\textarabic{عمرو صبري})
meet me weekly for the pass few years, read and tried to understand
...
conjecture on Grassmannians studied with Prof.\ Dylan Paul Thurston
and the quantum interpretation discussed with Prof.\ Shouhong Wang
(汪守宏) also broadened my understanding on discrete and conventional
quantum theories. I would like express my appreciation to all of these.

To have the current the content of the dissertation, I would also
like to thank John Gardiner for some inspiring discussion about quantum
probability measures over finite fields~\cite{Gardiner2014}. His
results were improved and motivated the transition from DQT to QIVPM
in Sec.~\ref{sec:Toward-IVPM}. Also, the unpublished computation
for the discrete Deutsch algorithm \cite{Deutsch1985,544199,Mermin2007}
...
Chen (谌可心), taught me a lot on how to communicate in English as well.
Others who help me indirectly on the content of the dissertation including
Kin Wai Chan, Prof.\ Huah Chu (朱樺), Weihua Liu (刘伟华), Caren Liu
(劉鈺平), Meng-Wei Chen (陳孟瑋), Hao-Chun Lee (李浩君), Chao-Hong Chen
(陳昭宏)\ldots , etc. This could be listed on and on. I still thank
you even if your name is not listed here, and sorry for my bad memory.

Many people in both the departments of Mathematics and Computer Science
have done everything to make my double-major smooth. \todo{Acknowledgments
cleaned up until here. }I need to thank all of them, especially directors
of graduate study in Mathematics, especially Prof.\ Christopher Judge
and Prof.\ Matthias Weber; directors of Ph.D. study in Computer Science,
especially Prof.\ Yuqing Melanie Wu (吴愈青) and Prof.\ \textturkish{Funda
Ergun}.
...
what I did from the perspective of a general PhD. in Physics and working
later in more computational industry.

\end{itemize}

Finally, I thank Jin-Ru Yang (楊謹如) for everything that could not be
written here.\end{acknowledgments*}
