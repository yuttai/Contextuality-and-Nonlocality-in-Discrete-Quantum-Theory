...
\tableofcontents{}\todo{Split Chapter~\ref{chap:DQT=000026DQC}
into ``Quantum Theories and Computing over Unrestricted Finite Fields''
and ``Quantum Theories and Computing over $\ff{p^{2}}$'' two chapters.
}
