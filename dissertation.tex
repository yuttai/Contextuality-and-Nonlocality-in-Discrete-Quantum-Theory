...
is, $\left(\alpha_{0},\alpha_{1}\right)\sim\left(\rme^{\rmi\theta}\alpha_{0},\rme^{\rmi\theta}\alpha_{1}\right)$.
...
degrees of freedom by effectively removing $\rme^{\rmi\theta}$ (``fibering
...
on the sphere. (b) Representation of the Hopf fibration, Eq.~(\ref{eq:HopfFibration}),
as a family of circles (the paths of $\rme^{\rmi\theta}$) on the
three-sphere $\Sphere{3}$. Although $\Sphere{3}$ cannot be directly
embedded in $\R^{3}$, $\Sphere{3}$ can be regarded as attaching
...
they differ only by an overall phase $\rme^{\rmi\theta}$. However,
...
ambiguity $\rme^{\rmi\theta}$ from the $n$-qubit states. If we take
