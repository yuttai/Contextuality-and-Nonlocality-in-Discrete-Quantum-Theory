...
the conventional projective Hilbert space~$\CP{D-1}$ by its discrete
analog in Chapter~\ref{chap:Unrestricted-Finite-Fields} and~\ref{chap:DQT=000026DQC}.
Since the replacing state spaces are discrete, after \todo{Keep writing\ldots}
