...
position wave functions and the probability amplitudes of a wave function.
...
of computations may not have any relations, the following computational
path may be completely different like the butterfly effect, and this
kind of difference cannot be compensated by error analysis techniques
easily. Therefore, the computational power of analog computers might
be far weaker than the prediction based on this kind of theoretical
models. \todo{Maybe extended to consider probabilistic model? }
...
possibilities dealing with real-valued models inspires us two types
of quantum models. Similar to classical analog computers, the quantum
circuit model, the most widely used model of quantum computing, manipulates
quantities which are not discrete apparently: the probability amplitudes
of quantum states. To address the similar inconsistency, we first
review the ``conventional quantum theory''\footnote{Alternative terminology in the literature includes ``actual,'' ``standard,''
