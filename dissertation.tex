...
\author{Yu-Tsung Tai}
\date{\today}
\maketitle[Department of Mathematics][Department of Computer Science]

%data for Acceptance Page
\defensedate{Defense Date}
\acceptancepage{Prof. Amr A. Sabry}{Prof. Dylan Paul Thurston}{Prof. Gerardo Ortiz}{Prof. Andrew J. Hanson}[Prof. Shouhong Wang]
