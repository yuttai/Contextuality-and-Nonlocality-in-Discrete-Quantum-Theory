...
we describe product and entangled $n$-qubit states used in quantum
circuit model, and the unitary matrices used to build circuit as addressed
...
and the foundations of quantum probability space.
...
\end{equation}
This can be accomplished by the Hopf fibration \cite{Hatcher2001,MosseriDandoloff2001,Bengtsson2007},
