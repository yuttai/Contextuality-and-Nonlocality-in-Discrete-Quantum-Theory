...
\item $\ip{\Phi}{\Psi}$ is the complex conjugate of $\ip{\Psi}{\Phi}$; 
\item $\ip{\Phi}{\Psi}$ is conjugate linear in its first argument and linear
in its second argument; 
\item $\ip{\Psi}{\Psi}$ is always non-negative and is equal to~0 only
