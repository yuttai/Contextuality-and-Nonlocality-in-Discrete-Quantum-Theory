...
is ultimately discrete or continuous, we considered two types of models
to incorporate our limitation of distinguishability into quantum theories.
By assuming the quantum states are ultimately quantized and distinguishable,
the first type of our quantum theories replaces the complex numbers
by discrete finite fields. We then shift our attention to focus on
the limitation of distinguishability itself, incorporate the finite
precision measurement into our model, and consider quantum interval-valued
probability measures.

After first suggesting by Richard Feynman and 40 years theoretical
developments~\cite{Feynman1982Simulating}, IBM, Rigetti, Google,
Microsoft, and many other companies start to build realistic quantum
computers to simulate chemical molecules for drug development and
to improving the classical algorithms like artificial and machine
learning \cite{Shieber2018,Kahn2019}. Before we dive into the issue
between our limitation of distinguishability and quantum theories
and computing, it is instructive to review how classical physical
quantities are characterized and computed. 
