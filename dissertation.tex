...
of quantum computation. Being agnostic about whether the reality is
ultimately discrete or continuous, we considered two types of quantum
...
two tasks, we notice that they require two different types of quantities.
The quantities required by RSA are discrete, and it is beyond our
...
among fractions are essentially the same as those among whole numbers
over the common denominator. In general, discrete computation can
be reliably repeated with exact equivalence, and any digital computer
...
cultures since very beginning. On one hand, the ancient Chinese philosopher
...
On the other hand, Greek mathematicians in the school of Pythagoras
believed every mathematical model must be ultimately discrete. They
believed so much that they in legend murdered Hippasus because he
found there is no minimum unit between a side of a square and its
...
Since the mathematical model is continuous, their corresponding physical
quantities are also assumed to be continuous. Later, these continuous
quantities becomes the basic component of analog computers. After
logarithm was discovered, a slide rule, also known as a slipstick,
is used to compute multiplication, division, and more complex operations
as a mechanical analog computer~\cite{wiki:SlideRule}. Charge amplifiers
is used to build electrical analog computers and compute the integration
in calculus \cite{wiki:Integrator,wiki:ChargeAmplifier}. 
