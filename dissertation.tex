...
inspires Chapter~\ref{chap:Introduction}.\tabularnewline
\midrule 
...
in the Tier 3 exam~\cite{Mathematics2018} are cited in Sec.~\ref{modalquantum}.\tabularnewline
\midrule
...
research supervised by Prof.\ Gerardo Ortiz inspired Sec.~\ref{subsec:Maximal-entanglement}
...
this dissertation as listed in Table~\ref{tab:teacher}. Even if
what taught by my other teachers are not directly related to this
dissertation, I have to thank for your teaching to make me more mature
and easier to communicate with others, especially my English teachers,
...
and~\ref{sec:Discrete-Quantum-Theory-(II)}.\tabularnewline
\midrule 
...
\ref{discretequantumtheoryI}, and~\ref{sec:Discrete-Quantum-Theory-(II)}.\tabularnewline
\midrule
...
Many people have done everything to make my double-major smooth and
to financially support me during my Ph.D. study. I need to thank all
of them, and the complete list of the support according to the employment
and award is listed in my Curriculum Vitae at the end of the dissertation.
...
associate. In the department of Mathematics, I need to thank the graduate
services assistant, Kate Forrest, and the directors of graduate study
in Mathematics, especially Prof.\ Christopher Judge, Prof.\ Matthias
Weber, and Prof.\ Michael A.\ Mandell. In the department of Computer
Science, I want to thank the graduate student office; the director
of AI/UI assignments, Charles Pope; the directors of Ph.D. study in
Computer Science, especially Prof.\ Yuqing Melanie Wu (吴愈青) and Prof.\ \textturkish{Funda
Ergun}; and the infrastructure and technology group (ITG). In particular,
I don't know how much computational power I consumed to count the
states in Sec.~\ref{subsec:Maximal-entanglement}. These computational
power not only came from the Linux systems in Computer Science but
also came from the Big Red II administrated by the University Information
Technology Services (UITS). The Indiana University Libraries was also
...
service, submitted the Purchase Recommendation Form to suggested IU
libraries to buy them.\todo{Acknowledgments cleaned up until here.
}

Except the financial support via employment and award, I have also
support by my family, especially my father Cheng-Tien Tai (戴振沺). He
always thinks one-step ahead and cares about my future more than I
do. Discussion with other family members and friends also helped me
to compose this dissertation or to do research in general. In particular,
I want to thank Prof.~Daniel Leivant, Prof.~Paul Purdom, Weihua
Liu (刘伟华), and classifies others as the following:\footnote{I only provide the Chinese name for some of them since I only know
their Chinese names and there is no unique way to alphabetize Chinese
into English. Hence, if I randomly choose a way to alphabetize their
name, it might just be a random string which might not be their English
name when they really want to use an English name. For the reader
who don't know Chinese, their names should be able to be copied directly
since the output of \XeLaTeX should be encoded in the Unicode.}

\begin{itemize}

\item The Ph.D. students in Mathematics, including, Kin Wai Chan,
ChunHsien Lu (呂俊賢), Cong Zhou (周蔥), Junyan Xu (许俊彦), Zhipeng Lu (路志鹏),
Robert Rose, Neal Coleman, Dami Lee, Ruiyu Yang (杨瑞雨), Yingwei Li
(李盈伟), Yu-Yuan Chen (陳裕元)\ldots{} etc.

\item My other family members, including, my mother Feng-Ming Chang
(張鳳鳴), my grandmother 戴許玉婷, my sister Sih-Sian Tai (戴司嫻), my cousins
Caren Liu (劉鈺平) and Kiwi Liu (劉子綺), \ldots{} etc.

\item My official and nonofficial roommates, including Meng-Wei Chen
(陳孟瑋), Yu ``Larry'' Chen (陈煜), Jing-Han Liou (劉經翰), Shu-Ling Wang
(王舒齡), and Wan-Ling ``Wynnie'' Chang (張婉鈴).

\item My classmates in NTU, including, Hao-Chun Lee (李浩君), Hsien-Ching
Kao (高憲慶), 鄭維,

\item My building mates, including Chao-Hong Chen (陳昭宏)
...
\item Hao-Chun Lee (李浩君) and for discussing what I did from the perspective
of a general PhD. in Physics and working later in more computational
industry.

\end{itemize}

\ldots , etc. This could be listed on and on. I still thank you even
if your name is not listed here, and sorry for my bad memory.

Finally, I want to thank Blue Coat system for providing K9 Web Protection
to block distractive websites to keep me focus, and Jin-Ru Yang (楊謹如)
for keeping the password and helping me control myself in general.\end{acknowledgments*}
