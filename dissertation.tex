...
In conventional quantum theory and computation, the probability amplitudes
are modeled by the continuum of complex numbers. This kind of model
doesn't take into account that human doesn't have the ability to distinguish
quantities differing only by an arbitrarily small extent. One possibility
is that the probability amplitudes in quantum theories are quantized.
This leads us to consider quantum theories and computing over finite
fields. Even if the probability amplitudes are actually continuous,
since human has no ability to distinguish the probability computed
by these probability amplitudes, it may be desirable to incorporate
the idea of measurement precision into the quantum theory, and consider
