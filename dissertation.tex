...
\newcommand{\CP}[1]{\mathbf{CP}^{#1}}  % Complex projective space
\newcommand{\DCP}[1]{\mathbf{DCP}^{#1}} % Discrete complex projective
\def\fh{\mathfrak{h}}
...
\[
\begin{array}{@{\!\!}c}
\hspace*{1.35cm}\xymatrix@C=0pt{\lstick{y=\ket{0}} & \qw & \multigate{3}{\uf} & \gate{~S^{\dagger}~} & \ctrl{3} & \gate{~S^{\dagger}~} & \multimeasureD{3}{\text{measure}}\\
...
\[
\begin{array}{c}
\hspace*{1.5cm}\xymatrix@C=0pt{\lstick{y=\ket{0}} & \qw & \multigate{3}{\uf} & \qw & \multimeasureD{3}{\text{measure}}\\
