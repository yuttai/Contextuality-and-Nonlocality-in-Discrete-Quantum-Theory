...
\documentclass[11pt,twoside,english]{iuphd}
\usepackage{amsmath}
\usepackage{amssymb}
\usepackage{fontspec}
...
Ortiz, Prof.~Amr Sabry, and Prof.~Andrew Hanson for publishing
...
reviewed by Prof. Amr Sabry. I want to thank Prof. Lawrence Moss
for inviting me to present our results in the interdisciplinary logic
seminar and theory seminar in Computer Science, co-chairing my Tier
3 committee, writing an assessment letter for me, and drawing my attention
on Prof.~Abramsky's paper~\cite{Abramsky2012}, which inspired me
to merge quantum probability with discrete quantum theories. And I
thank John Gardiner for inspiring discussion on the difficulties merging
them~\cite{Gardiner2014}. These results are improved and motivated
the transition from DQT to QIVPM in Sec.~\ref{sec:Toward-IVPM}.
...
\begin{abstract*}\todo{Rewrite the abstract so that the committee
can sign it. Prof. Thurston: “To address the same issue, the thesis
contains four different theories each have different pros and cons.
The abstract should said them seperately and explicitly.” }Most
of the quantum computing models are based on the continuum of real
numbers, despite the fact that classical digital computers faithfully
realize the prediction of discrete computational models, while analog
computers in reality are far weaker than the theoretical prediction
of continuous computational models. Since one of the important factors
of this gap is the measurement precision, we hope to build a more
faithful model by investigating discrete quantum computing models
and incorporating the idea of finite precision measurement into the
quantum theory.
...
papers. Explicitly say what question we wan to solve. In particular,
merging quantum mechanics and computer science is too broad for a
thesis. }The marriage of quantum mechanics and computer science first
envisioned and popularized by Feynman has created an awkward, but
opportune, moment. This embarrassing dilemma was concisely summarized
by Prof.~Aaronson that one of the the following three statements
is false \cite{AaronsonArkhipov2011,BFRDARW2013}:
...
models and their physical realizations \todo{Update this table to
include }}
...
quantum theory” where necessary and it will be reviewed in Chapter~\ref{chap:Conventional-Quantum-Theory}~\footnote{Alternative terminology in the literature includes “actual,”
“standard,” and “ordinary” quantum theory.}.
