...
it is sufficient to only consider measuring a quantum circuit in the
computational basis because measuring in another basis is the same
as applying a quantum gate and measuring in the computational basis.
In this situation, the Born rule for pure states, Eq.~(\ref{eq:Born}),
...
such that the pullback of $\muB_{\rho}$ is $\mu$, i.e.,
\begin{equation}
