...
Cheng-Tien Tai  and Feng-Ming Chang. Thanks for encouraging me to
study abroad and all your support during my Ph.D. study. \todo{Find
a way to include my parent's Chinese name. If I can find a way, also
include Amr's Arabic name.}\end{dedication}
...
of Physics 2017 workshop reviewed by Prof. Amr Sabry. Thank Prof.
Lawrence Moss for inviting me to present our results in the interdisciplinary
logic seminar and SICE theory seminar, co-chairing my Tier 3 committee,
...
term paper for SLST-T501 Academic Writing course as presented in Sec.~\ref{discretequantumtheoryI}.
Thank Traci Nagle for going through the literature review about finite
precision measurement and contextuality discussed for CSCI-Y790 Writing
and Editing course as presented in Sec.~\ref{sec:Quantum-Contextuality}.

Thank Elizabeth ``Betsy'' Merceron and Kexin Chen for helping me
pass TEPAIC exam. 

Thank Hao-Chun Lee and Hsien-Ching Kao for discussing what I did in
the prospective of a general Ph.D. in Physics, and working later in
more computational industry.

Finally, thank Jin-Ru Yang for holding my hand and leading me here,
and hope I could be with you to wherever place until the death separating
us apart eventually.\end{acknowledgments}
\begin{abstract}
...
This marriage of quantum mechanics and computer science first envisioned
and popularized by Feynman has created an awkward, but opportune,
moment. The embarrassing dilemma was concisely described by Aaronson
with the following three statements \cite{AaronsonArkhipov2011,BFRDARW2013}:
...
any physically realizable model of computation --- is correct \cite{BernsteinVazirani1997,Kaye2007}. 
\end{enumerate}
...
is correct Shor's efficient factoring algorithm is realizable, and
we can prove there is no efficient classical factoring algorithm,
we concede \ref{enu:extended-Church-Turing-Thesis}. Otherwise, if
we cannot implement Shor's algorithm no matter how hard we try, textbook
quantum mechanics, i.e., \ref{enu:Textbook-quantum-mechanics} may
need to be improved by a better theory. It is unlikely that there
...
which is the sum of the field norms for the complex coefficients~\cite{wiki:FieldNorm}.
