...
to incorporate our limitation of distinguishability. By assuming the
quantum states are quantized and distinguishable, the continuum of
complex numbers is replaced by finite fields which serves as the basis
of the first type of our quantum theories and computing. We then shift
our attention from the reality to the limitation of distinguishability
...
of whole numbers are fractions, the operation among fractions can
be considered as the operation among whole numbers after we find the
common denominator, and the resulting numbers faithfully predicts
the corresponding quantities. In general, discrete computation can
...
cultures from the very beginning. Some people, including Greek mathematicians
in the school of Pythagoras, tried to apply their discrete idea into
their model, and believed even the mathematical models must be ultimately
discrete. In legend, they murdered Hippasus because he found there
is no minimum unit between a side of a square and its diagonal. Comparing
to admit that the length of a square's diagonal is not a physical
quantity or there is no square physically, working with a mathematical
model without minimum unit seems more appealing, and their corresponding
physical quantities are also assumed to be continuous. An ancient
Chinese philosopher Chuang-tzu (庄子) expressed this belief as ``If
a one-foot-long stick is cut into halves every day, the cutting will
never come to an end''\footnote{``一尺之棰，日取其半，萬世不竭。'' in Chinese \cite{Zhuangzi1999,Liu2018}.}.
...
\begin{tabular}{c}
\noalign{\vskip\doublerulesep}
Prediction\tabularnewline[\doublerulesep]
\noalign{\vskip\doublerulesep}
\noalign{\vskip\doublerulesep}
of Events\tabularnewline[\doublerulesep]
\noalign{\vskip\doublerulesep}
\end{tabular} & %
\begin{tabular}{c}
\noalign{\vskip\doublerulesep}
...
\noalign{\vskip\doublerulesep}
\end{tabular} & Defined &  &  & Undefined &  & Defined\tabularnewline\addlinespace
\midrule
\addlinespace
\midrule 
\addlinespace
