...
ability to answer because whether the space itself is ultimately discrete
...
\end{comment}
\begin{comment}
Our first discrete model replaces the complex numbers by an unrestricted
...
choose $\theta=\phi$ without loss of generality, reducing the form
...
when we move on to interval-valued situation! }
\end{comment}
