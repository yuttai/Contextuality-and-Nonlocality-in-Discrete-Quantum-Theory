...
types of quantum models. Similar to classical analog computers, quantum
...
review the ``conventional quantum theory'' (CQT)\footnote{Alternative terminology in the literature includes ``actual,'' ``standard,''
...
of the induced probabilities... }This idea will be extended to quantum
