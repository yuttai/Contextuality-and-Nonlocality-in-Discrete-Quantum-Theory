...
the other hand, finite fields will be based to define the fraction-like
...
\todo{Make sure whether realistic quantum computers branch their
computation based on its probability amplitudes or measured probabilities?
If they can only branch on measured probabilities, it will provide
another reason why we want to study the precision of the induced probabilities...
