...
\begin{sidewaystable}
\noindent \centering{}\caption{\label{tab:committee}I want to thank the professors co-authored with
...
\midrule 
\addlinespace
 & Co-author & Co-author & Co-author &  &  &  & Most of Chapters~\ref{chap:Conventional-Quantum-Theory}, \ref{chap:Unrestricted-Finite-Fields},and~\ref{chap:DQT=000026DQC}
is based on~\cite{geometry2013} and~\cite{DQT2014}; most of Chapter~\ref{chap:QIVPM}
is based on~\cite{THOS2018}.\tabularnewline\addlinespace
\midrule 
\addlinespace
Research committee & Co-chair & Co-chair & Member & Co-chair & Member &  & Some questions in the dissertation proposal are answered in Chapter~\ref{chap:QIVPM},and
some of the remaining ones are explained in Chapter~\ref{chap:Further-Discussion}.\tabularnewline\addlinespace
\midrule 
\addlinespace
...
is cited in Sec.~\ref{discretequantumtheoryIIb}.\tabularnewline\addlinespace
\midrule
\addlinespace
Tier 3 committee & Co-chair & Co-chair &  & Member &  & Co-chair & Two of the assigned papers in the Tier 3 exam \cite{Schumacher2012-SCHMQT,doi:10.1142/S0217984913500644}
...
cited in Sec.~\ref{subsec:Classical-and-Quantum}.\tabularnewline\addlinespace
\bottomrule
...
\renewcommand{\tabular}{\tabularx{\linewidth}}
\renewcommand{\endtabular}{\endtabularx} 
\begin{tabular}{M{Jin-Tzu~Chen}cM{MATH-M522}Y}
\toprule 
\addlinespace
Instructor & School & Course & Relation with the dissertation\tabularnewline\addlinespace
\midrule
\midrule 
\addlinespace
Tom Lewis & IUB & SLST-T501 & Sec.~\ref{subsec:Discrete-Deutsch-algorithm} is based on the term
paper of \emph{Academic Writing}.\tabularnewline\addlinespace
\midrule 
\addlinespace
Michael\nolinebreak[3] A. Mandell & IUB & MATH-M522 & The textbook~\cite{Hatcher2001} of \emph{Topology II} is cited
in Chapters~\ref{chap:Introduction} and~\ref{chap:Conventional-Quantum-Theory}.\tabularnewline\addlinespace
\midrule 
\addlinespace
Steven Myers & IUB & CSCI-B502 & The textbook~\cite{AroraBarak2009} of \emph{Computational Complexity}
is cited in Sec.~\ref{modalquantumcomputing}.\tabularnewline\addlinespace
\midrule 
\addlinespace
Valery Lunts & IUB & MATH-M501 & The textbook~\cite{DummitFoote2004} of \emph{Survey of Algebra}
is cited in Sec.~\ref{sec:background}, \ref{discretequantumtheoryI},
and~\ref{sec:Discrete-Quantum-Theory-(II)}.\tabularnewline\addlinespace
\midrule 
\addlinespace
...
is cited in Sec.~\ref{CQC1qubitBloch.sec}, \ref{sec:background},
...
is cited in Sec.~\ref{subsec:Vector-Spaces}.\tabularnewline\addlinespace
\bottomrule
\end{tabular}% ERT block 2 (after LyX tabular)
\renewcommand{\tabular}{\ORIGtabular}
\renewcommand{\endtabular}{\ORIGendtabular} 
...
by error analysis techniques.\tabularnewline\addlinespace
\midrule 
\addlinespace
