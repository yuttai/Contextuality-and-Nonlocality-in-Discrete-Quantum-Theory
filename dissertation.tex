...
\section{Irreducible Discrete $D$-dimensional States: Generalized Discrete
...
$p(p^{2}-1)$ such values.\todo{{Check reference...}} Given this
requirement, which is similar in form to the conservation of probability,
but not as useful due to the lack of orderable probability values,
we can immediately conclude that the discrete analog of the Hopf fibration
is again 
\begin{eqnarray}
X & = & 2\,\mathrm{Re}\ \alpha_{0}\alpha_{1}^{*}=2x_{0}x_{1}+2y_{0}y_{1}\,,\nonumber \\
