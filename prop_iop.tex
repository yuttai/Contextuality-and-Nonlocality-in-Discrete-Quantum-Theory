...
could be modeled in a simpler way. If the complete initial condition
...
In another word, Newtonian physics could be modeled by a cryptodeterministic\footnote{The word ''cryptodeterminism'' is used by Peres which means
\begin{quote}
...
\end{quote}
in~\cite{Peres1991,peres1995quantum}.} measure defined as follow.
...
question can be formulated by whether the quantum mechanics could
