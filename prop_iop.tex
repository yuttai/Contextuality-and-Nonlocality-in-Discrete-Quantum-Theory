...
\int_{\Omega}X\rmd\bar{\mu} & = & \left[\inf\set{\sum_{i=1}^{N}x_{i}a_{i}}{a_{i}\in\bar{\mu}\left(A_{i}\right)\textrm{ and }\sum_{i=1}^{N}a_{i}=1},\right.\\
 ...
 & = & \left[\inf\set{a_{1}+2a_{2}}{a_{1}\in\bar{\mu}\left(\{HT,TH\}\right)\textrm{ and }a_{2}\in\bar{\mu}\left(\{TT\}\right)\textrm{ and }a_{1}+a_{2}=1},\right.\\
 &  & \left.\sup\set{a_{1}+2a_{2}}{a_{1}\in\bar{\mu}\left(\{HT,TH\}\right)\textrm{ and }a_{2}\in\bar{\mu}\left(\{TT\}\right)\textrm{ and }a_{1}+a_{2}=1}\right]\\
 & = & \left[\inf\set{a_{1}+2a_{2}}{\frac{1}{2}\le a_{1}\le1\textrm{ and }a_{2}=0\textrm{ and }a_{1}+a_{2}=1},\right.\\
 &  & \left.\sup\set{a_{1}+2a_{2}}{\frac{1}{2}\le a_{1}\le1\textrm{ and }a_{2}=0\textrm{ and }a_{1}+a_{2}=1}\right]\\
 & = & \left[\inf\set{a_{1}}{\frac{1}{2}\le a_{1}\le1\textrm{ and }a_{1}=1},\right.\\
 &  & \left.\sup\set{a_{1}}{\frac{1}{2}\le a_{1}\le1\textrm{ and }a_{1}=1}\right]\\
 & = & \left[1,1\right]
\end{eqnarray*}
