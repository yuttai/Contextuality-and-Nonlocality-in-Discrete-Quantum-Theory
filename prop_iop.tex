...
\begin{eqnarray*}
 ...
 & = & \textrm{(Need to verify the detail, but seems correct...)}\\
 ...
 & = & \left[\min_{\rho\in\coreBorn\left(\bar{\mu},\events'\right)}\expval{\mathbf{O}}_{\rho},\max_{\rho\in\coreBorn\left(\bar{\mu},\events'\right)}\expval{\mathbf{O}}_{\rho}\right]
\end{eqnarray*}
\end{proof}
