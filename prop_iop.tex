...
\end{equation}
\footnote{Notice that it doesn't have square root, and this definition only
appears in \cite{544199}... Need to this definition in other sources.}\end{definition}
