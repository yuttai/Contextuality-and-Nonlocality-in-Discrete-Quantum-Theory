...
\begin{lemma}\label{lemma:real2interval}Consider a regular pair~$\left(\mathscr{I},\iota\right)$.
...
\end{equation}
is a $\left(1,\frac{1}{3}\right)$-deterministic and $\left(\frac{1}{3},0\right)$-deterministic.
...
quantum IVPM. In another word, $\iota_{\infty}\circ\mu$ is $\left(1/n,0\right)$-deterministic
by lemma~\ref{lemma:real2interval}.\end{lemma}
