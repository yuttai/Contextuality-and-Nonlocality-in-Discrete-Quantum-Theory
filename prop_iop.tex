...
\begin{equation}\eqalign{ 
 & \prod_{j}\expval{\mathbf{O}_{j}}_{\bar{\mu}}\stackrel{\textrm{Lemma }\ref{lemma:expectation-singleton}}{=}\prod_{j}\left\{ \expval{\mathbf{O}_{j}}_{\mu}\right\} =\prod_{j}\left\{ \lambda_{j,k}\right\} \\
= & \left\{ \prod_{j}\lambda_{j,k}\right\} =\expval{\prod_{j}\mathbf{O}_{j}}_{\mu}\stackrel{\textrm{Lemma }\ref{lemma:expectation-singleton}}{=}\expval{\prod_{j}\mathbf{O}_{j}}_{\bar{\mu}}\,. 
}\end{equation}
\end{proof}
