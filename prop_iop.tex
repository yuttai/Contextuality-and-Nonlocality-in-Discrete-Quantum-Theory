...
of dimension~$d$ with orthonormal basis $\left\{ \ket{0},\ket{1},\ldots,\ket{d-1}\right\} $
...
are not commuting. Consider the function~$\bar{\mu}:\events\rightarrow\mathscr{I}_{0}$
defined by 
\begin{equation} 
...
equation~(\ref{eq:QuantumInterval-valuedProbability-Convex}). There
are several cases:
\begin{itemize}
...
is true when when $P_{0}=\mathbb{1}$.
...
are not commuting. Hence,
\begin{equation}
\bar{\mu}\left(P_{0}\vee P_{1}\right)+\bar{\mu}\left(P_{0}P_{1}\right)=\unknown+\imposs=\bar{\mu}\left(P_{0}\right)+\bar{\mu}\left(P_{1}\right)\,.
\end{equation}
\end{itemize}
Therefore, equation~(\ref{eq:QuantumInterval-valuedProbability-Convex})
holds when $P_{0}=\proj{\psi}\in\mathcal{S}$. By lemma~\ref{lemma:quantum-convex-condition-lemma},
equation~(\ref{eq:QuantumInterval-valuedProbability-Convex}) is
also true when when $P_{0}=\mathbb{1}-\proj{\psi}$, where $\proj{\psi}\in\mathcal{S}$.
\item If neither the above two cases holds, we have $\bar{\mu}\left(P_{0}\vee P_{1}\right)+\bar{\mu}\left(P_{0}P_{1}\right)\subseteq\unknown+\unknown=\bar{\mu}\left(P_{0}\right)+\bar{\mu}\left(P_{1}\right)$.
\end{itemize}
...
for any~$P$, the state~$\rho$ must satisfy $\mu_{\rho}^{\mathrm{B}}(P)$
...
\begin{lemma}\label{lemma:classical-quantum-convex}Given a quantum
IVPM~$\bar{\mu}:\events\rightarrow\mathscr{I}$, if $\bar{\mu}^{\Omega}:2^{\Omega}\rightarrow\mathscr{I}$
are all convex for any orthonormal basis~$\Omega$, then $\bar{\mu}$
is convex.\end{lemma}
...
\begin{lemma}\label{lemma:classical-convex-condition-lemma}Given
a classical IVPM~$\bar{\mu}^{\Omega}:2^{\Omega}\rightarrow\mathscr{I}$,
...
Then, lemma~\ref{lemma:classical-convex-condition-lemma} proves
equation~(\ref{eq:classical-convex}).
\item When $E_{0}\subseteq E_{1}$ or $E_{1}\subseteq E_{0}$, equation~(\ref{eq:classical-convex})
is also followed by lemma~\ref{lemma:classical-convex-condition-lemma}.
\end{enumerate}
...
\item If $\bar{\mu}\left(P_{0}\vee P_{1}\right)+\bar{\mu}\left(P_{0}P_{1}\right)\subseteq\bar{\mu}\left(P_{0}\right)+\bar{\mu}\left(P_{1}\right)$,
...
\begin{proof}The direct consequence of lemma~\ref{lemma:classical-convex-condition-lemma}
...
\begin{proof}The direct consequence of lemma~\ref{lemma:classical-quantum-convex}
and lemma~\ref{lemma:classical-3-elements}. \end{proof}
