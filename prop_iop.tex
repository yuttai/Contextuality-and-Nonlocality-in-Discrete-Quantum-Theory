...
A real or interval-valued probability is a way to model our belief
whether an event will happen or not. Classically, when we toss a coin
or throw a needle, if we know all the initial condition, we can determine
