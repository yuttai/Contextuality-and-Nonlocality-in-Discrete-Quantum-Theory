...
\subsection{Quantum $\delta$-deterministic Probability Measures}

Since there is no quantum $\mathscr{I}_{\mathrm{D}}$-valued probability
measures, we want to know whether there is something which is almost
quantum $\mathscr{I}_{\mathrm{D}}$-valued probability measures. This
...
Given the preceding definition, theorem~\ref{thm:Kochen-Specker-expectation}
says there is no quantum $0$-deterministic probability measures.
In contrast, given a three-dimensional Hilbert space, there is $\frac{1}{3}$-deterministic
probability measures\nb$\iota_{\frac{1}{3}}\circ\mu_{\frac{\mathbb{1}}{3}}^{\mathrm{B}}:\events\rightarrow\left\{ \imposs,\left[\frac{1}{3},\frac{1}{3}\right],\left[\frac{2}{3},\frac{2}{3}\right],\necess\right\} $.
The real problem is if we decrease $\delta$ from $\frac{1}{3}$,
when quantum $\delta$-deterministic probability measures starts to
disappear?
