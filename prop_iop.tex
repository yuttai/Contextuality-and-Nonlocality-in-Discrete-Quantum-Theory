...
defined to be $\mathbb{0}$. In particular, when $\mathscr{I}=\set{\left\{ a\right\} }{a\in\left[0,1\right]}$,
$\bar{\mu}$ is essentially a quantum real-valued probability measure
and $\bar{\mu}^{\Omega}$ is essentially a classical real-valued probability
measure. In another word, this lemma also holds for real-valued probability
measures.\end{lemma}
