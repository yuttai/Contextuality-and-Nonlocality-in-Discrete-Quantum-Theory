...
\begin{itemize}
\item If $\pmeas\left(P_{0}\right)=\pmeas\left(P_{1}\right)=0$, then
\begin{equation}\eqalign{ 
& \bar{\mu}(P_{0})+\bar{\mu}(P_{1})\subseteq\left[0,2\delta\right]\\
\overset{2\delta<1-\delta}{\Rightarrow} & \bar{\mu}\left(P_{0}+P_{1}\right)\cap\left[1-\delta,1\right]=\emptyset\Rightarrow\bar{\mu}\left(P_{0}+P_{1}\right)\subseteq\left[0,\delta\right]\\
