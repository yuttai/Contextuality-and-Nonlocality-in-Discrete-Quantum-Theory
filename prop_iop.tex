...
which is a step function, i.e., $X=\sum_{i=1}^{N}x_{i}\mathbf{1}_{A_{i}}$,
where $A_{i}\in\events$ and $\mathbf{1}_{A}$ is the indicator function
defined by 
\begin{equation} 
...
\begin{eqnarray}
\int X\rmd\pmeas & = & \sum_{i=1}^{N}x_{i}\pmeas\left(A_{i}\right)\textrm{ .}
\end{eqnarray}
...
\begin{eqnarray*}
\int_{A}X\rmd\bar{\mu} & = & \left[\inf\set{\sum_{i=1}^{N}x_{i}a_{i}}{a_{i}\in\bar{\mu}\left(A_{i}\right)\textrm{ and }\sum_{i=1}^{N}a_{i}=\min\bar{\mu}\left(A\right)},\right.\\
 &  & \left.\sup\set{\sum_{i=1}^{N}x_{i}a_{i}}{a_{i}\in\bar{\mu}\left(A_{i}\right)\textrm{ and }\sum_{i=1}^{N}a_{i}=\max\bar{\mu}\left(A\right)}\right]\textrm{ .}
\end{eqnarray*}
...
allowed probability, which is represented by the requirement on $a_{i}\in\bar{\mu}\left(A_{i}\right)$.
However, I don't have a clear intuition on why they want $\sum_{i=1}^{N}a_{i}=\min\bar{\mu}\left(A\right)$
and $\sum_{i=1}^{N}a_{i}=\max\bar{\mu}\left(A\right)$, and we will
have a more intuitive definition following this line when we move
on to Choquet integral~\cite{Choquet1954,Grabisch2016}.

After we have the definition, we can consider the IVPM~$\bar{\mu}$
in example~\ref{ex3} as an example. Because $\bar{\mu}\left(\Omega\right)=\left[1,1\right]$,
we have 
\begin{eqnarray*}
\int_{\Omega}X\rmd\bar{\mu} & = & \left[\inf\set{\sum_{i=1}^{N}x_{i}a_{i}}{a_{i}\in\bar{\mu}\left(A_{i}\right)\textrm{ and }\sum_{i=1}^{N}a_{i}=1},\right.\\
 &  & \left.\sup\set{\sum_{i=1}^{N}x_{i}a_{i}}{a_{i}\in\bar{\mu}\left(A_{i}\right)\textrm{ and }\sum_{i=1}^{N}a_{i}=1}\right]\\
 & = & \left[\inf\set{a_{1}+2a_{2}}{a_{0}\in\bar{\mu}\left(\{HH\}\right)\textrm{ and }a_{1}\in\bar{\mu}\left(\{HT,TH\}\right)\textrm{ and }a_{2}\in\bar{\mu}\left(\{TT\}\right)\textrm{ and }a_{0}+a_{1}+a_{2}=1},\right.\\
 &  & \left.\sup\set{a_{1}+2a_{2}}{a_{0}\in\bar{\mu}\left(\{HH\}\right)\textrm{ and }a_{1}\in\bar{\mu}\left(\{HT,TH\}\right)\textrm{ and }a_{2}\in\bar{\mu}\left(\{TT\}\right)\textrm{ and }a_{0}+a_{1}+a_{2}=1}\right]\\
 & = & \left[\inf\set{a_{1}+2a_{2}}{0\le a_{0}\le\frac{1}{2}\textrm{ and }\frac{1}{2}\le a_{1}\le1\textrm{ and }a_{2}=0\textrm{ and }a_{0}+a_{1}+a_{2}=1},\right.\\
 &  & \left.\sup\set{a_{1}+2a_{2}}{0\le a_{0}\le\frac{1}{2}\textrm{ and }\frac{1}{2}\le a_{1}\le1\textrm{ and }a_{2}=0\textrm{ and }a_{0}+a_{1}+a_{2}=1}\right]\\
 & = & \left[\inf\set{a_{1}}{0\le a_{0}\le\frac{1}{2}\textrm{ and }\frac{1}{2}\le a_{1}\le1\textrm{ and }a_{0}+a_{1}=1},\right.\\
 &  & \left.\sup\set{a_{1}}{0\le a_{0}\le\frac{1}{2}\textrm{ and }\frac{1}{2}\le a_{1}\le1\textrm{ and }a_{0}+a_{1}=1}\right]\\
 & = & \left[\frac{1}{2},1\right]
\end{eqnarray*}
What does this means...?

In other references, since the left-end and the right-end of an IVPM
satisfies equation~(\ref{eq:classical-complement}), 
