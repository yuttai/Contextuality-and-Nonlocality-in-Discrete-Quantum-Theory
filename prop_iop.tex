...
\Leftrightarrow & \forall P\in\events\ \mu_{\rho}^{\mathrm{B}}\left(P\right)\in\iota\left(\mu_{\rho}^{\mathrm{B}}\left(P\right)\right)\\ 
\Rightarrow & \forall\textrm{ normalized pure state }\ket{\psi}\ \mu_{\rho}^{\mathrm{B}}\left(\proj{\psi}\right)\in\iota\left(\mu_{\rho}^{\mathrm{B}}\left(\proj{\psi}\right)\right) 
}\end{equation}
\end{proof}
