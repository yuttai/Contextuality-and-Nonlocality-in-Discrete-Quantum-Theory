...
One way to formulate this question is to ask whether we can model
the whole quantum theory by quantum cryptodeterministic measures.
...
The answer is ``no'' due to the Kochen-Specker theorem.
...
1 & if $\bar{\mu}(P)=\necess$ .
}\label{cor:Kochen-Specker-IVPM} \end{equation}
