...
\footnote{\yutsung{The word ''cryptodeterminism'' is used by A. Peres~\cite{peres1995quantum}.
However, he hasn't defined it explicitly so it is hard to tell how
to use it correctly...}}Although a real or interval-valued probability measure could be used
