...
There are various different integral defined for IVPMs, and the most
famous one is called the Choquet integral~\cite{Choquet1954,GilboaSchmeidler1994,Grabisch2016}.
Let $X=\sum_{i=1}^{N}x_{i}\mathbf{1}_{E_{i}}$ be a random variable
with $x_{1}\le x_{2}\le\ldots\le x_{N-1}\le x_{N}$ and $\bar{\mu}:\events\rightarrow\mathscr{I}$
a classical IVPM such that $l:\events\rightarrow\left[0,1\right]$
...
observable~$\mathbf{O}$, whose spectrum decomposition is given by
