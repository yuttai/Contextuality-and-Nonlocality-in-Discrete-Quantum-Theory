...
so that a $\mathscr{I}_{\mathrm{D}}$-valued QIVPM is $0$-deterministic.
...
no $\delta$-deterministic probability measures for small $\delta$
...
\overset{d\delta<1-\delta}{\Rightarrow} & \bar{\mu}\left(\bigcup_{i=1}^{N}P_{i}\right)\cap\left[1-\delta,1\right]=\textrm{Ø}\Rightarrow\bar{\mu}\left(\bigcup_{i=1}^{N}P_{i}\right)\subseteq\left[0,\delta\right]\\
...
\Rightarrow & \bar{\mu}\left(\bigcup_{i=1}^{N}P_{i}\right)\subseteq\left[1-\delta,1\right]\Rightarrow\pmeas\left(\bigcup_{i=1}^{N}P_{i}\right)=1=\sum_{i=1}^{N}\pmeas(P_{i})\textrm{ .}
}\end{equation}
