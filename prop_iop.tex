...
the belief of an event which has already happened. For example, if
we toss the coin in example~\ref{ex1}, and see $HH$, our belief
of which event has happened can be model by the following example.
\begin{equation}
\begin{array}{c@{\qquad\qquad}c}
\begin{array}{rcl}
\bar{\mu}(\emptyset) & = & 0\\
...
to be improved and predict perfectly. One of the ``no'' answer was
