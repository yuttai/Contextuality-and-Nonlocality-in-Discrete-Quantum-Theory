...
Consider the function~$\bar{\mu}:\events\rightarrow\mathscr{I}_{0}$
defined in Table~\ref{tab:non-Born-QIVPM}
\begin{table}
...
\midrule 
\addlinespace
$\mathbb{0}$, $\proj{0}$, $\proj{i'}$ & $\imposs$\tabularnewline\addlinespace
\midrule 
\addlinespace
$\mathbb{1}$, $\mathbb{1}-\proj{0}$, $\mathbb{1}-\proj{i'}$ & $\necess$\tabularnewline\addlinespace
\midrule 
\addlinespace
...
\end{figure}
The inner product of two distinguish states $\ket{i'}\ne\ket{j'}$
is $\ip{i'}{j'}=\frac{1}{4}\ne0$. Also, the inner product $\ip{i'}{0}=1/\sqrt{2}\ne0$.
Hence, a set of projections $\mathcal{S}=\left\{ \proj{0}\right\} \cup\set{}$.
...
\item When $P_{0}=\proj{0}$, if $P_{1}=\proj{0}+P_{2}$, then equation~(\ref{eq:QuantumInterval-valuedProbability-Convex})
...
There are two cases:
\begin{itemize}
\item When $P_{1}=\mathbb{1}-\proj{0}$, we have
\begin{equation}\eqalign{ 
 & \bar{\mu}\left(P_{0}\vee P_{1}\right)+\bar{\mu}\left(P_{0}P_{1}\right)=\bar{\mu}\left(\mathbb{1}\right)+\bar{\mu}\left(\mathbb{0}\right)\\
={} & \bar{\mu}\left(\mathbb{1}-\proj{0}\right)+\bar{\mu}\left(\proj{0}\right)=\bar{\mu}\left(P_{0}\right)+\bar{\mu}\left(P_{1}\right)\,.
}\end{equation}
\item When $P_{1}\ne\mathbb{1}-\proj{0}$, we have
\begin{equation}
...
holds when $P_{0}=\proj{0}$. Similarly, equation~(\ref{eq:QuantumInterval-valuedProbability-Convex})
holds when $P_{0}=\proj{\ps}$ or $P_{0}=\proj{\ps'}$. By lemma~\ref{lemma:quantum-convex-condition-lemma},
equation~(\ref{eq:QuantumInterval-valuedProbability-Convex}) is
also true when when $P_{0}=\mathbb{1}-\proj{0}$, $\mathbb{1}-\proj{\ps}$,
or $\mathbb{1}-\proj{\ps'}$.
...
for all~$j$. The last equation never holds proving the theorem.\end{proof}
