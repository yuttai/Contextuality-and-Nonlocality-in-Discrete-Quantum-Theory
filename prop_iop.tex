...
for all $\omega\in\Omega$, then $\necess=\bar{\mu}\left(\Omega\right)\subseteq\sum_{\omega\in\Omega}\bar{\mu}\left(\left\{ \omega\right\} \right)\subseteq\left[0,d\delta\right]\Rightarrow d\delta>1$.
A contradiction!
...
then $\necess=\bar{\mu}\left(\Omega\right)\subseteq\sum_{\omega\in\Omega}\bar{\mu}\left(\left\{ \omega\right\} \right)\subseteq\left[2-2\delta,d\right]\Rightarrow2\delta>1$.
A contradiction!
\end{casenv}
