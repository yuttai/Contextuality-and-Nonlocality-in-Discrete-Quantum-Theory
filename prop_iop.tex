...
\begin{equation}
\int X\rmd\bar{\mu}=\left[\sum_{i=1}^{N^{+}}x_{i}^{+}\Delta\mul\left(E_{i}^{+\prime}\right)+\sum_{i=1}^{N^{-}}x_{i}^{-}\Delta\mur\left(E_{i}^{-\prime}\right),\sum_{i=1}^{N^{+}}x_{i}^{+}\Delta\mur\left(E_{i}^{+\prime}\right)+\sum_{i=1}^{N^{-}}x_{i}^{-}\Delta\mul\left(E_{i}^{-\prime}\right)\right]\,.\label{eq:interval-expectation}
\end{equation}
\end{definition}
