...
if $\events'\subseteq\events$ commutes, then $\coreBorn\left(\bar{\mu},\events'\right)\ne\emptyset$.\end{cor}
...
\begin{eqnarray*}
 ...
 & \Rightarrow & \pmeas\left(\tau\left(P\right)\right)\in\bar{\mu}'\left(\tau\left(P\right)\right)\textrm{ for all }P\in\widehat{\events}\\
 & \Rightarrow & \pmeas\left(\tau\left(P\right)\right)\in\bar{\mu}\left(P\right)\textrm{ for all }P\in\widehat{\events}
\end{eqnarray*}
Then, it is easy to verify that the density matrix~$\sum_{j=0}^{d-1}\pmeas\left(\left\{ j\right\} \right)\proj{j}\in\coreBorn\left(\bar{\mu},\events'\right)$.\end{proof}
