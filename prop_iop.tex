...
\end{equation}
Let $\events'$ denote the minimal commuting sub-event space containing
$\left\{ P_{i}\right\} _{i=1}^{N}$. Then, we have the corresponding
theorem. 
...
\begin{equation}
\expval{\mathbf{O}}_{\bar{\mu}}=\left[\min_{\rho\in\mathrm{core}\left(\bar{\mu},\events'\right)}\expval{\mathbf{O}}_{\rho},\max_{\rho\in\mathrm{core}\left(\bar{\mu},\events'\right)}\expval{\mathbf{O}}_{\rho}\right]\textrm{ .}\label{eq:quantum-interval-expectation-core}
\end{equation}
