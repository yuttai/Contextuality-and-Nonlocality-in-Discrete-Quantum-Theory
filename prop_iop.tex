...
\begin{equation}
\bar{\mu}^{\Omega}\left(\Omega\backslash E\right)=\bar{\mu}\left(\mathbb{1}-\sum_{\ket{j}\in E}\proj{j}\right)=\left[1,1\right]-\bar{\mu}^{\Omega}\left(E\right)\textrm{ .}
\end{equation}
\item For a collection $\left\{ E_{i}\right\} _{i=1}^{N}\subseteq2^{\Omega}$
of pairwise disjoint events, we have
\begin{equation}
\bar{\mu}^{\Omega}\left(\bigcup_{i=1}^{N}E_{i}\right)=\bar{\mu}\left(\sum_{i=1}^{N}\sum_{\ket{j}\in E_{i}}\proj{j}\right)\subseteq\sum_{i=1}^{N}\bar{\mu}^{\Omega}\left(E_{i}\right)\textrm{ .}
\end{equation}
\end{itemize}
\end{proof}
...
Also, 
\begin{eqnarray*}
 &  & \mu_{\rho}^{\mathrm{B}}\left(\proj{i}\right)
 =\sum_{j=1}^{N}\mu'\left(\left\{ j\right\} \right)\mu_{\ket{j}}^{\mathrm{\mathrm{B}}}\left(\proj{i}\right)
 =\mu'\left(\left\{ j\right\} \right)
 =\mu'\left(\tau\left(\proj{i}\right)\right)\textrm{ for all }i\textrm{ ,}\\
 &  & \mu_{\rho}^{\mathrm{B}}\left(P_{1}\right)+\mu_{\rho}^{\mathrm{B}}\left(P_{2}\right)
 \overset{\textrm{IH}}{=}\mu'\left(\tau\left(P_{1}\right)\right)+\mu'\left(\tau\left(P_{2}\right)\right)
 =\mu'\left(\tau\left(P_{1}+P_{2}\right)\right)
\end{eqnarray*}
for commuting\nb$P_{0},P_{1}\in\events$ with $P_{0}P_{1}=\mathbb{0}$.
...
is a quantum IVPM such that $\mathrm{core}\left(\iota\circ\mu_{\phi}^{\mathrm{\mathrm{B}}}\right)$
...
i.e., for any quantum probability measure~$\mu\in\mathrm{core}\left(\iota\circ\mu_{\phi}^{\mathrm{\mathrm{B}}}\right)$,
...
\begin{equation}
\iota_{n,\delta}\left(1-x\right)=\left[\frac{n-k-\delta}{n},\frac{n-k+\delta}{n}\right]=\left[1,1\right]-\iota_{n,\delta}\left(x\right)\textrm{ .}
\end{equation}
When $k/n<x<\left(k+1\right)/n$, we have $1-k/n>1-x>1-\left(k+1\right)/n$
so that 
\begin{equation}
\iota_{n,\delta}\left(1-x\right)=\left[1-\frac{k+1}{n},1-\frac{k}{n}\right]=\left[1,1\right]-\iota_{n,\delta}\left(x\right)\textrm{ .}
\end{equation}
...
\begin{equation}
\iota_{n,\delta}\left(x_{1}+x_{2}\right)\subseteq\left[\frac{k_{1}}{n},\frac{k_{1}}{n}\right]+\iota_{n,\delta}\left(x_{2}\right)\subseteq\iota_{n,\delta}\left(x_{1}\right)+\iota_{n,\delta}\left(x_{2}\right)\textrm{ ,}
\end{equation}
...
= &\left[\frac{k_{1}}{n},\frac{k_{1}+1}{n}\right]+\left[\frac{k_{2}}{n},\frac{k_{2}+1}{n}\right]=\iota_{n,\delta}\left(x_{1}\right)+\iota_{n,\delta}\left(x_{2}\right)\textrm{ .} 
}\end{equation}
\end{itemize}
\end{itemize}
\end{proof}

\begin{example}For any positive integer~$n$, there is an additive
...
we always have
\begin{equation}
\widehat{\iota}_{n}\left(1-x\right)=\left[1-\frac{k+1}{2n},1-\frac{k-1}{2n}\right]\cap\left[0,1\right]=\left[1,1\right]-\widehat{\iota}_{n}\left(x\right)\textrm{ .}
\end{equation}
\item It is sufficient to prove the case when $N=2$, i.e., for a set $\left\{ x_{1},x_{2}\right\} \subseteq\left[0,1\right]$,
...
= &\widehat{\iota}_{n}\left(x_{1}\right)+\widehat{\iota}_{n}\left(x_{2}\right)\textrm{ .} 
}\end{equation}
\end{itemize}
\end{itemize}
\end{proof}
...
\subsubsection{Convex and Finite Number of Intervals in Low Dimension}

\subsubsection{Convex but Infinite Number of Intervals}
...
\Rightarrow & \left[x_{0}+x_{1}+x_{2}+c\left(x_{0}+x_{1}+x_{2}\right)\right]+\left[x_{2}+c\left(x_{2}\right)\right]\\
 & \le\left[x_{0}+x_{2}+c\left(x_{0}+x_{2}\right)\right]+\left[x_{1}+x_{2}+c\left(x_{1}+x_{2}\right)\right]\textrm{ .} }\end{equation}
Also, 
\begin{equation}\eqalign{ 
 & c\left(x_{0}+x_{1}+x_{2}\right)+c\left(x_{2}\right)\le c\left(x_{0}+x_{2}\right)+c\left(x_{1}+x_{2}\right)\\
...
\Rightarrow & \left[x_{0}+x_{2}-c\left(x_{0}+x_{2}\right)\right]+\left[x_{1}+x_{2}-c\left(x_{1}+x_{2}\right)\right]\\
 & \le\left[x_{0}+x_{1}+x_{2}-c\left(x_{0}+x_{1}+x_{2}\right)\right]+\left[x_{2}-c\left(x_{2}\right)\right]\textrm{ .} 
}\end{equation}
