...
Notice that $\left[1.7,1.8\right]$ in example~\ref{ex:expectation}
is just the right-hand side of equation~(\ref{eq:Rosenmuller}).
Let compute the left-hand side of equation~(\ref{eq:Rosenmuller})
in table~\ref{table:Choquet} and see they are equal.
\begin{table}
...
\hline 
\hline 
$x_{i}^{+}$ & 1 & 2 & \tabularnewline
\hline 
$E_{i}^{+}$ & $E$ & $\overline{E}$ & \tabularnewline
\hline 
$E_{i}^{+\prime}$ & $E$ & $\Omega$ & $\emptyset$\tabularnewline
\hline 
$\mul\left(E_{i}^{+\prime}\right)$ &  &  & \tabularnewline
\hline 
 &  &  & \tabularnewline
\hline 
 &  &  & \tabularnewline
\hline 
 &  &  & \tabularnewline
\hline 
\end{tabular}\caption{\label{table:Choquet}}
\end{table}
...
basis\nb$\Omega=\left\{ \ket{k}\right\} _{k=0}^{d-1}$. By theorem~\ref{thm:sub-event-space},
there is a commuting sub-event space\nb$\widehat{\events}$ with
$\widehat{\events}\subseteq\events$ and a bijection\nb$\tau:\widehat{\events}\rightarrow2^{\Omega}$
