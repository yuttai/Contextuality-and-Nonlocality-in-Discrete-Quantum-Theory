...
\item $\left\Vert \rho-\rho'\right\Vert \le d\delta$.
...
\begin{proof}Since
\begin{equation}
d\delta\ge\left\Vert \rho'-\rho\right\Vert =\max_{\ip{\psi}{\psi}=1}\left|\melem{\psi}{\rho'-\rho}{\psi}\right|\,,
\end{equation}
we have
\begin{equation}
d\delta\ge\left|\melem{\psi}{\rho'-\rho}{\psi}\right|=\left|\mu_{\rho'}^{\mathrm{B}}\left(\proj{\psi}\right)-\mu_{\rho}^{\mathrm{B}}\left(\proj{\psi}\right)\right|\label{eq:Born_rule_difference}
\end{equation}
