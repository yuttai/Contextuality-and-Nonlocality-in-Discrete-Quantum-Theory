...
defined by precomposition is a classical probability measure\footnote{\begin{proof}
...
\end{equation}
\end{proof}}. Since that ``precomposition'' is called ``pullback'' in differential
geometry~\cite{wiki:Pullback}\footnote{Whether this kind of ``pullback'' is categorical will need further
investigate.}, we will use their notation, write the precomposition $\left(\lambda E.\mu\left(\varphi\left(E\right)\right)\right)$
...
random variable, but summarize quantum measurement process as observable.
