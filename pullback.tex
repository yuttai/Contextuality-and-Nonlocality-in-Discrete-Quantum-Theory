...
simply write $\overline{E}$ if the sample space~$\Omega$ is clear
from the context.  Moreover, we require $\mu\left(E_{0}\cup E_{1}\right)=\mu\left(E_{0}\right)+\mu\left(E_{1}\right)$
