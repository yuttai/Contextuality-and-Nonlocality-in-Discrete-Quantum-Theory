...
might be induced by the pure state~$\ket{\psi_{0}}\times\ket{\psi_{1}}$\footnote{Notice that we only discuss only discuss real 1-dimensional projectors
...
when there is no confusion.}. Therefore, the set of 1-dimensional projectors mapping to impossible,
