...
are processes bounded in space, time, energy, and other resources~\cite{Jaeger2007}.
...
quantum interval-valued probabilities measures. 
\begin{itemize}
\item Assess the validity of fundamental theorems of quantum mechanics,
such as Gleason~\cite{gleason1957,Redhead1987-REDINA,peres1995quantum},
...
in a quantum formulation stripped away of infinite resources. We will
aim to provide a definite answer to the Meyer-Mermin debate~\cite{PhysRevLett.83.3751,Mermin1999,BarrettKent2004}
on the impact of finite precision measurements on the relevance of
