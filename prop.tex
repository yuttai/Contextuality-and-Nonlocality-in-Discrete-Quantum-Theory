...
\item $\iota\left(1-x\right)=\left[1,1\right]-\iota\left(x\right)$, and 
\item $\iota\left(\sum{}_{i=1}^{N}x_{i}\right)\subseteq\sum{}_{i=1}^{N}\iota\left(x_{i}\right)$.
\end{itemize}
\end{definition}
...
\end{proof}
\begin{example}For any positive odd integer~$n$, consider the collection
of intervals~$\mathscr{I}_{n}=\left\{ \left[0,0\right],\left[1,1\right]\right\} \cup\set{\left[\frac{k}{n},\frac{k+1}{n}\right]}{k=0,\ldots,n-1}$,
and the map~$\iota_{n}:\left[0,1\right]\rightarrow\mathscr{I}_{n}$
defined by 
\[
\iota_{n}\left(x\right)=\begin{cases}
\left[0,0\right] & \textrm{, if }x=0\textrm{ ;}\\
\left[\frac{k}{n},\frac{k+1}{n}\right] & \textrm{, if }\frac{k}{n}<x\le\frac{k+1}{n}<\frac{1}{2}\textrm{ ;}\\
\left[\frac{1}{2}-\frac{1}{2n},\frac{1}{2}+\frac{1}{2n}\right] & \textrm{, if }\frac{1}{2}-\frac{1}{2n}<x<\frac{1}{2}+\frac{1}{2n}\textrm{ ;}\\
\left[\frac{k}{n},\frac{k+1}{n}\right] & \textrm{, if }\frac{1}{2}<\frac{k}{n}\le x<\frac{k+1}{n}\textrm{ ;}\\
\left[1,1\right] & \textrm{, if }x=1\textrm{ .}
\end{cases}
\]
\end{example}
\begin{proof}
...
\item $\iota\left(0\right)=\left[0,0\right]$.
\item $\iota\left(1\right)=\left[1,1\right]$. 
\item When $x=0$, $\iota\left(1-x\right)=\iota\left(1\right)=\left[1,1\right]=\left[1,1\right]-\iota\left(x\right)$.\\
When $\frac{k}{n}<x\le\frac{k+1}{n}<\frac{1}{2}$, we have $1-\frac{k}{n}>1-x\ge1-\frac{k+1}{n}>\frac{1}{2}$
...
When $\frac{1}{2}-\frac{1}{2n}<x<\frac{1}{2}+\frac{1}{2n}$, we have
$\frac{1}{2}+\frac{1}{2n}>1-x>\frac{1}{2}-\frac{1}{2n}$ so that $\iota\left(1-x\right)=\left[1-\frac{k+1}{n},1-\frac{k}{n}\right]=\left[1,1\right]-\left[\frac{k}{n},\frac{k+1}{n}\right]=\left[1,1\right]-\iota\left(x\right)$.\\
The rest of the cases are true because of symmetry.
\item ...................
\end{itemize}
\end{proof}
