...
it is more related to the Kochen-Specker theorem than the Bell theorem...}}\begin{lemma}Given a quantum interval-valued probability measure~$\bar{\mu}:\events\rightarrow\mathscr{I}$,
