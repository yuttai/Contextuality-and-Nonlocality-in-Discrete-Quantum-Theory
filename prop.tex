...
quantum IVPM. Surprisingly, we found a quantum IVPM which can not
be induced by a state, while Shapley proved a classical convex IVPM
can always be induced by a classical ``state''~\cite{Shapley1971,Grabisch2016},
...
states if we break it into pieces. Our examples also suggest that
...
validity the fundamental theorems of quantum mechanics followed up
by Gleason's theorem, such as Bell~\cite{BellBook1987,Redhead1987-REDINA,peres1995quantum,Jaeger2007}
