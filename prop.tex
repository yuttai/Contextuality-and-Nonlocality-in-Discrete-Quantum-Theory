...
for any $\ket{\psi_{0}}\in\angle^{-1}\left(\left[0,\frac{\pi}{2}-\theta_{0}\right]\right)$.\end{lemma}
\begin{proof}
\begin{figure}
\begin{centering}
...
\end{proof}
\begin{thm}\label{thm:arcsin-one-over-sqrt-three}Given $\theta_{0}\in\left(\frac{\pi}{4},\frac{\pi}{2}-\arcsin\left(\frac{1}{\sqrt{3}}\right)\right]$
and an interval-valued frame function~$\bar{f}:S^{2}\rightarrow\mathscr{I}$,
if $\bar{f}\left(\ket{\psi}\right)=\imposs$ for every $\ket{\psi}\in\angle^{-1}\left(\left[\theta_{0},\frac{\pi}{2}\right]\right)$,
...
of the yellow circle is $\theta_{0}=\frac{\pi}{2}-\frac{\pi}{5}\in\left(\frac{\pi}{4},\frac{\pi}{2}-\arcsin\left(\frac{1}{\sqrt{3}}\right)\right]$,
and the latitude of the green circle is $\frac{\pi}{5}=\frac{\pi}{2}-\theta_{0}$.}
\end{figure}
