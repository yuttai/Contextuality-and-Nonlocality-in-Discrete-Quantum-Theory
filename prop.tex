...
the proof of theorem~\ref{thm:pi-div-4}.}
\end{figure}
We are going to prove by contradiction. Suppose $\theta_{0}\le\frac{\pi}{4}$.
As illustrated in figure~\ref{fig:three-dimensional-real-frame-2},
the green circle represent the states whose latitude is $\theta_{0}$
so that .every state above it maps to $\imposs$, for example, 
\end{proof}
