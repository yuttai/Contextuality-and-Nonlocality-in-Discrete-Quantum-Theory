...
Despite the great success of classical and quantum probability, an
infinite precision uncomputable probability cannot really satisfactory
...
given more and more resources. In particular, we could summarize example~\ref{ex:three-dimensional-three-value}
and \ref{ex:three-dimensional-4-value} and Gleason's theorem in table~\ref{table_long}.
\begin{table}[ht]
\center{%
...
\label{table_long}
\end{table}
According to table~\ref{table_long}, when we increase the measurement
resources, interval-valued probability measures could more and more
likely be identified to a particular state. Although the tend is clear,
there are still a lot of questions need to be answered, including: 
\begin{description}
