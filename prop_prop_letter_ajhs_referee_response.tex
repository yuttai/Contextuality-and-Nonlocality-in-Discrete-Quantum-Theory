...
$\eventsC$, when $\bar{\mu}$ is a classical one. $\bar{\mu}$ is
$\delta$-deterministic if, for every event $P\in\events'$, we have
that either $\bar{\mu}\left(P\right)\subseteq\left[0,\delta\right]$
or $\bar{\mu}\left(P\right)\subseteq\left[1-\delta,1\right]$. \end{definition}

\begin{table}
\noindent \centering{}\caption{\label{tab:classical-IVPMs}Example $\frac{1}{4}$-deterministic classical
IVPMs~$\bar{\mu}_{A}$, $\bar{\mu}_{B}$ and $\bar{\mu}_{C}$ on
commuting events $P$.}
\begin{tabular}{cccc}
\toprule 
\addlinespace
$P$  & $\bar{\mu}_{A}(P)$  & $\bar{\mu}_{B}(P)$  & $\bar{\mu}_{C}(P)$\tabularnewline
\midrule
\midrule 
\addlinespace
$\mathbb{0}$  & $\imposs$  & $\imposs$  & $\imposs$\tabularnewline
\midrule 
\addlinespace
$\proj{0}$  & $\necess$  & $\left[\frac{3}{4},\frac{4}{5}\right]$  & $\left[\frac{3}{4},1\right]$\tabularnewline
\midrule 
\addlinespace
$\proj{1}$  & $\imposs$  & $\left[\frac{1}{5},\frac{1}{4}\right]$  & $\left[1,\frac{1}{4}\right]$\tabularnewline
\midrule 
\addlinespace
$\mathbb{1}$  & $\necess$  & $\necess$  & $\necess$\tabularnewline
\bottomrule
...
Then, it is easy to construct $\frac{1}{4}$-deterministic classical
IVPMs~$\bar{\mu}_{A}$, $\bar{\mu}_{B}$ and $\bar{\mu}_{C}$ defined
in Table~\ref{tab:classical-IVPMs}. 
