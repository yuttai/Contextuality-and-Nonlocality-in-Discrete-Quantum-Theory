...
and $\proj{2}$. A event might be happened (H) or not happened (N),
and the experimental results could be summarized by a $0$-deterministic
classical IVPM~$\bar{\mu}_{C}$.}
\begin{tabular}{ccccc}
\toprule 
\addlinespace
$P$  & Trial~1 & Trial~2 & Trial~3 & $\bar{\mu}_{C}(P)$\tabularnewline
\midrule
\midrule 
\addlinespace
$\mathbb{0}$  & N & N & N & $\imposs$\tabularnewline
\midrule 
\addlinespace
$\proj{0}$  & N & N & N & $\imposs$\tabularnewline
\midrule 
\addlinespace
$\proj{1}$  & N & N & N & $\imposs$\tabularnewline
\midrule 
\addlinespace
$\proj{2}$ & H & H & H & $\necess$\tabularnewline
\midrule 
\addlinespace
$\mathbb{1}-\proj{0}$  & H & H & H & $\necess$\tabularnewline
\midrule 
\addlinespace
$\mathbb{1}-\proj{1}$  & H & H & H & $\necess$\tabularnewline
\midrule 
\addlinespace
$\mathbb{1}-\proj{2}$ & N & N & N & $\imposs$\tabularnewline
\midrule 
\addlinespace
$\mathbb{1}$  & H & H & H & $\necess$\tabularnewline
\bottomrule
...
These results could be interpreted as in Sec.~\ref{sec:Classical-=0000BC-deterministic},
and summarized to a $0$-deterministic classical IVPM~$\bar{\mu}_{C}$.
Given any Hilbert space of dimension~$d\ge3$, the Kochen-Specker
theorem asserts that we cannot have a table of experimental results
summarizing to a $0$-deterministic QIVPM\cite{BELL_1966,kochenspecker1967,Redhead1987-REDINA,Mermin1990Simple,peres1995quantum,Jaeger2007,Held2016}.
However, we could have a table of experimental results if some results
are missing.
