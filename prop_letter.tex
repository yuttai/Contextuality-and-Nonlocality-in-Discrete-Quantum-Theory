...
\begin{thm}\label{thm:Shapley}
  \cite{Shapley1971,GilboaSchmeidler1994,Grabisch2016}~For a
  QIVPM~$\bar{\mu}:\events\rightarrow\mathscr{I}$, if a subspace of events~$\events_C\subseteq\events$ commutes, then
