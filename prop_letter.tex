...
and get a function~$\bar{\mu}:\events\overset{\mu}{\rightarrow}\left[0,1\right]\overset{\iota}{\rightarrow}\mathscr{I}$.
Although $\bar{\mu}$ has the same the domain and range, $\bar{\mu}$
may or may not be a QIVPM. For example, the following theorem highlight
the situation when $\bar{\mu}$ cannot be a QIVPM.
