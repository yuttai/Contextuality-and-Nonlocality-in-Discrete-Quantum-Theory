...
not only of resolving the Meyer-Mermin debate, but also revealing of a
...
$\rho = \sum_{j=1}^{N}q_{j}\proj{\phi_{j}}$, where $q_j > 0$ and
...
rule~\citep{Born1983,Mermin2007}.
...
on all possible events. Assume a Hilbert space of dimention $d=3$ with
