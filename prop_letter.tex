...
a three-dimensional Hilbert space, there is a QIVPM~$\bar{\mu}:\events\rightarrow\mathscr{I}$
...
Born QIVPMs]\label{thm:Finite-precision-Gleason}In a three-dimensional
