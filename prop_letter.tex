...
the difference between the Born quantum probabilities on any 1-dimensioal
...
by definition. As a concrete example of Thm.~\ref{thm:Finite-precision-Gleason},
since $\rho_{1}\in\coreBorn\left(\widehat{\iota}_{2}\circ\mu_{\rho_{0}}^{\mathrm{B}},\events\right)$
and $\rho_{0}\in\coreBorn\left(\widehat{\iota}_{2}\circ\mu_{\rho_{1}}^{\mathrm{B}},\events\right)$
which is easy to see on the commuting subspace of event~$\events_{C}$
according to Table~\ref{tab:Compute-the-QIVPM}, we have $\left\Vert \rho_{0}-\rho_{1}\right\Vert \le\frac{1}{2}$,
and this is indeed the case because $\left\Vert \rho_{0}-\rho_{1}\right\Vert =\frac{1}{24}$~\citep{HOSTunpublished}.
