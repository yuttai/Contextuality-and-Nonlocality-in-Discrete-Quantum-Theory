...
to a QIVPM~$\bar{\mu}_{3}$: $\bar{\mu}_{3}(\proj{0})=\left[\frac{1}{2},\frac{1}{2}\right]$,
$\bar{\mu}_{3}(\proj{1})=\left[\frac{1}{2},\frac{1}{2}\right]$, and
$\bar{\mu}_{3}(\proj{2})=\left[0,0\right]$, ... etc. For the same
...
QIVPM~$\bar{\mu}_{1}$ and the Born QIVPM~$\bar{\mu}_{3}$ defined
in Sec.~\ref{sec:Interval-Uncertainty} are both $1$-deterministic.
