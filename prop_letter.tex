...
more and more indeterminate behavior. For example, when $\delta=\frac{1}{3}$,
two possible collection of intervals\nb$\mathscr{I}$ are $\left\{ \imposs,\left[0,\frac{1}{3}\right],\left[\frac{2}{3},1\right],\necess\right\} $
and $\left\{ \imposs,\left[\frac{1}{6},\frac{1}{6}\right],\left[\frac{1}{3},\frac{1}{3}\right],\left[\frac{2}{3},\frac{2}{3}\right],\left[\frac{5}{6},\frac{5}{6}\right],\necess\right\} $.
Our technical result will be
