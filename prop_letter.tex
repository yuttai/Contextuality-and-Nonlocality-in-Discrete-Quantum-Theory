...
is a QIVPM whose values on the minimal subspace of events containing
...
based on $\mu_{1}$ on $\events_{C}$.}
\begin{tabular}{ccc}
\toprule 
$P$ & $\mu_{1}\left(P\right)$ & $\widehat{\iota}_{2}\left(\mu_{1}\left(P\right)\right)$\tabularnewline
\midrule
\midrule 
...
we know not only $\widehat{\iota}_{n}\circ\mu_{\rho}^{\mathrm{B}}$
