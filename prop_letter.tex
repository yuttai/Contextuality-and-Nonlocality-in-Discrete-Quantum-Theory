...
what a QIVPM could be when it exists. A conventional quantum probability
measure can be easily be constructed using the Born rule~\citep{Born1983,peres1995quantum,544199,Jaeger2007}
from a unique state, and this is the only way to construct a conventional
quantum probability measure according to Gleason's theorem~\citep{gleason1957,Redhead1987-REDINA,peres1995quantum}. 

In Sec.~\ref{sec:Interval-Uncertainty}, the only non-trivial QIVPM~
$\bar{\mu}_{3}$ is induced by the state~$\proj{\ps}$. The way we
extending a state to a QIVPM will first be generalized in this section,
and introduce a finite-precision extension of the Born rule~\citep{Born1983,peres1995quantum,544199,Jaeger2007}.
