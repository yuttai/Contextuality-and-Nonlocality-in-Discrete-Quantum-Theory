...
\begin{definition}Assume a collection of intervals $\mathscr{I}$
including $\imposs$ and $\necess$. \end{definition}
...
considered in Sec.~\ref{sec:Born}, there is always a state consistent
with it because $\rho\in\coreBorn\left(\iota\circ\mu_{\rho}^{\mathrm{B}},\events\right)$.
