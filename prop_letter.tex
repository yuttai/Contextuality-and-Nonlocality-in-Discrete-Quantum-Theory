...
restriction of QIVPMs to mutually commuting events recovers the definition of
...
${\cal H}$ of dimension $d$ relative to a 0-deterministic QIVPM is fully
...
$\muB_{\rho}$ is the eigenvalue $\lambda_i$ whose projector
