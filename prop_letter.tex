...
i.e., $\lambda_{i}=j$ and $P_{i}=\proj{j-1}$. Two fragments of valid
...
Born rule~\citep{peres1995quantum,544199,Jaeger2007}. The Born rule
is essential to compute the conventional quantum probability because
any quantum probability measure can be induced by the Born rule according
to Gleason's theorem~\citep{gleason1957,Redhead1987-REDINA,peres1995quantum}.
