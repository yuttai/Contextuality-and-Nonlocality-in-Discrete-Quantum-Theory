...
\item One of them projects onto a subspace which the other one projects
onto.
\end{itemize}
...
For example, since $\left\Vert \rho_{0}-\rho_{1}\right\Vert \le\frac{1}{24}$,
we have $\rho_{0}\in B_{\epsilon}\left(\rho_{1}\right)$ and $\rho_{1}\in B_{\epsilon}\left(\rho_{0}\right)$.

After we have enough definitions, we can replace the QIVPM~$\bar{\mu}$
