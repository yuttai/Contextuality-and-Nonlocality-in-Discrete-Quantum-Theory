...
with $\delta<\frac{1}{3}$, then $\mu:\events\rightarrow\left[0,1\right]$
defined by
\begin{equation}
\mu(P)=\begin{cases}
...
have $\bar{\mu}\left(P_{0}+P_{1}\right)\subseteq\bar{\mu}(P_{0})+\bar{\mu}(P_{1})$.
Without loss of generality, there are two cases:
\begin{itemize}
\item If $\pmeas\left(P_{0}\right)=\pmeas\left(P_{1}\right)=0$, then\begin{subequations}
\begin{eqnarray}
 &  & \bar{\mu}(P_{0})+\bar{\mu}(P_{1})\subseteq\left[0,2\delta\right]\\
 & \overset{2\delta<1-\delta}{\Rightarrow} & \bar{\mu}\left(P_{0}+P_{1}\right)\cap\left[1-\delta,1\right]=\emptyset\\
 & \Rightarrow & \bar{\mu}\left(P_{0}+P_{1}\right)\subseteq\left[0,\delta\right]\\
 & \Rightarrow & \pmeas\left(P_{0}+P_{1}\right)=0=\pmeas\left(P_{0}\right)+\pmeas\left(P_{1}\right)\textrm{ .}
\end{eqnarray}
\end{subequations}
\item If $\pmeas\left(P_{0}\right)=0$ and $\pmeas\left(P_{1}\right)=1$,
then\begin{subequations}
\begin{eqnarray}
 &  & \bar{\mu}(P_{0})+\bar{\mu}(P_{1})\subseteq\left[1-\delta,1\right]\\
 & \Rightarrow & \pmeas\left(P_{0}+P_{1}\right)=1=\pmeas\left(P_{0}\right)+\pmeas\left(P_{1}\right)\textrm{ .}
\end{eqnarray}
\end{subequations}
\end{itemize}
Therefore, we always have $\pmeas\left(P_{0}+P_{1}\right)=\pmeas\left(P_{0}\right)+\pmeas\left(P_{1}\right)$.
