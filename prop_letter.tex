...
Then,
\begin{equation}
\begin{aligned} & \mathrel{\hphantom{=}}\bar{\mu}\left(P_{0}+P_{1}-P_{0}P_{1}\right)+\bar{\mu}\left(P_{0}P_{1}\right)\\
...
\end{aligned}
\end{equation}
Therefore, $\iota$ must satisfy Eqs.~(\ref{eq:iota-constraints})
