...
and this state can easily construct $\bar{\mu}$ according to the
Born rule~\citep{Born1983,peres1995quantum,544199,Jaeger2007}. However,
...
length of the intervals in $\mathscr{I}_{n}$ is $1/n$, it is the
upper bound of the difference $\left|\mu_{\rho'}^{\mathrm{B}}\left(\proj{\psi}\right)-\mu_{\rho}^{\mathrm{B}}\left(\proj{\psi}\right)\right|=\left|\melem{\psi}{\rho-\rho'}{\psi}\right|$.
