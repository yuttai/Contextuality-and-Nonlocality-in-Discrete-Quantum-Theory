...
diagonalized by a common orthonormal basis~$\Omega$. By restricting
to the subspace of commuting events generated by the set of projectors
associated with $\Omega$, $\bar{\mu}$ become a 0-deterministic classical
IVPM\nb$\bar{\mu}'$. Moreover, the expectation values of the observables\nb$\expval{\mathbf{O}_{j}}_{\bar{\mu}}$
...
relative to $\bar{\mu}'$\nb\citep{HOSTunpublished}. The Choquet
integral relative to $\bar{\mu}'$ is a singleton set which have an
intuitive the product rule\nb$\left\{ x_{0}\right\} \cdot\left\{ x_{1}\right\} =\left\{ x_{0}x_{1}\right\} $.
...
product of the family relative to $\bar{\mu}'$, the expectation values
of the observables has the corresponding property: 
\begin{equation}
