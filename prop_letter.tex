...
$\iota\circ\mu$ could map to only finite number of intervals. For
...
More concretely, consider two states $\rho_{0}=\frac{1}{3}\proj{0}+\frac{1}{3}\proj{1}+\frac{1}{3}\proj{2}$
