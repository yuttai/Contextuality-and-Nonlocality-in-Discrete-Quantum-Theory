...
and $\rho'$, $\left\Vert \rho-\rho'\right\Vert =\max_{\ip{\psi}{\psi}=1}\left|\melem{\psi}{\rho-\rho'}{\psi}\right|$~\citep{544199},
...
\yutsung{Compare the norm we used with other distances. For example,
the trace distance defined in Sec.~9.2.1 in Nielsen and Chuang~\citep{544199}.}
