...
and vice versa. In another word, quantum IVPMs with $\mathscr{I}_{\infty}$
...
to $\events_{0}$ where every projectors are mutually commutative.
Recall commutative sub-event space reduces quantum IVPMs to classical
IVPMs. In general, we haven't found any classical IVPM has a non-empty
core, and Shapley has proved that a good enough classical IVPM always
