...
to be a QIVPM, the composited function~$\iota\circ\mu$ may still
be a QIVPM when $\iota$ is not a THOS rule. In this case, the composited
function~$\iota\circ\mu$ could only map to a finite set of intervals.
