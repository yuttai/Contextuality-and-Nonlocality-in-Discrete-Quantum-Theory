...
``unsupportable''~\citep{Mermin1999}.  The question of
whether contextuality is consistent with experimental
outcomes continues to be an active topic of discussion~\citep{Kent1999,HavlicekKrennSummhammerSvozil2001,SimonBruknerZeilinger2001,Cabello2002,Larsson2002,Appleby2002,Peres2003,BarrettKent2004,Appleby_2005,Spekkens2005,GuehneKleinmannCabelloEtAl2010,MazurekPuseyKunjwalEtAl2016}.
...
terms of ``$\delta$-determinism'', with $\delta$ denoting a
\emph{range} of outcomes, reducing to the purely deterministic
