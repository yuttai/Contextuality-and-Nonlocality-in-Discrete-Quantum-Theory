...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Even if quantum mechanics is invented for more than 60 years, quantum
measurement is still a mystery and a source of different interpretations
and non-classical phenomena, including non-locality and contextuality.
...
quantum interval-valued probability measures (IVPMs). Quantum IVPM
provides not only a uniform framework to understand Gleason's theorem~\cite{gleason1957,Redhead1987-REDINA,peres1995quantum}
