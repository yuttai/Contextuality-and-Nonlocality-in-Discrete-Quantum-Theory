...
mutually orthogonal projectors $\left\{ P_{i}\right\} _{i=1}^{N}$, we
have:
\begin{equation}
...
with spectral decomposition $\proj{1} + 2\,\proj{2} +
3\,\proj{3}$. Here are two fragments of valid probability measures
$\mu_1$ and $\mu_2$ that can associated with this space:
$\mu_1(\proj{0}) = 0.5$, $\mu_1(\proj{1}) = 0.5$,
$\mu_1(\proj{2}) = 0$, and $\mu_2(\proj{0}) = 0$,
$\mu_2(\proj{1}) = 0.5$, $\mu_2(\proj{2}) = 0.5$. By the Born rule,
the first probability measure corresponds to the quantum system being
in the state $1/\sqrt{2}(\ket{0}+\ket{1})$ and the second corresponds
to the quantum system being in the state
$1/\sqrt{2}(\ket{1}+\ket{2})$. The expectation value of the observable
