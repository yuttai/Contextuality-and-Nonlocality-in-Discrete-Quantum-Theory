...
$P$. This set $P$ includes the empty projection~$\mathbb{0}$, the
identity projection~$\mathbb{1}$, projections of the form
$\proj{\psi}$ where $\ket{\psi}$ is a pure quantum state, sums of
\emph{orthogonal} projections, and products of \emph{commuting}
projections. In a well-defined quantum probability
