...
\end{aligned}
\end{equation}
Then, for any $x_{0}'$ and $x_{1}'\in\left[0,1\right]$, we can substitute
$x_{0}$ and $x_{1}$ by $\left(x_{0}'-x_{1}'\right)/2$ , substitute
$x_{2}$ by $x_{1}'$, and get the following inequality 
\begin{eqnarray}
