...
More concretely, consider two states $\rho_{0}=\frac{1}{3}\cdot\proj{0}+\frac{1}{3}\cdot\proj{1}+\frac{1}{3}\cdot\proj{2}$
...
On the other hand, 
\begin{eqnarray*}
\mu_{\rho_{1}}^{\mathrm{B}}\left(\proj{\psi}\right) & = & \frac{7}{24}\cdot\left|\ip{\psi}{0}\right|^{2}+\frac{1}{3}\cdot\left|\ip{\psi}{0}\right|^{2}+\frac{3}{8}\cdot\left|\ip{\psi}{0}\right|^{2}
\end{eqnarray*}
