...
will show some QIVPMs may not be induced by any classical IVPM, i.e.,
no state is consistent with these kind of QIVPMs.
...
to get $\bar{\mu}_{3}$. The way we replace numbers by intervals containing
