...
may still be a QIVPM under some suitable conditions. For example,
Eq.~(\ref{eq:iota-Inclusion}) can be weaken as follow: for any numbers~$x_{0}$
and $x_{1}\in\left[0,1\right]$, their sum~$x_{0}+x_{1}\in\left[0,1\right]$
implies
\begin{equation}
