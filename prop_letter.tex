...
$P$. This set includes the empty projection~$\mathbb{0}$, the identity
projection~$\mathbb{1}$, projections of the form $\proj{\psi}$
...
$\mu\left(\mathbb{1}-P\right)=1-\mu\left(P\right)$, and for each
pair of \emph{orthogonal} projections $P_{0}$ and $P_{1}$, we have:
\begin{equation}
\bar{\mu}\left(P_{0}P_{1}\right)\subseteq\bar{\mu}\left(P_{0}\right)+\bar{\mu}\left(P_{1}\right)\textrm{ ,}\label{eq:QuantumProbability-Addition}
\end{equation}
where $P_{0}$ and $P_{1}$ are called orthogonal if $P_{0}P_{1}=\mathbb{0}$.
