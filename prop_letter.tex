...
\noindent where
$\left\{\mathbb{1},\sigma_{x},\sigma_{y},\sigma_{z}\right\}$ are the
Pauli matrices acting on a pair of spin-$\frac{1}{2}$ states. These
matrices satisfy
...
or~$-1$; in each row and column, the observables commute; and in each
row and column except the third column, each operator is the product
of the other two. To find a QIVPM~$\bar{\mu}$ \ldots
