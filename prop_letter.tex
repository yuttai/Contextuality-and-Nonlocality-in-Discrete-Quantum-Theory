...
to seek a simple rule to construct them, and to understand which states
...
get might contradict to each other. This contradicting results would
exclude any possible state from being consistent with them.
