...
state being consistent with the measurement results. Although we will
not dig into the general framework to avoid this problem here~\citep{HOSTunpublished},
...
length of the intervals in $\mathscr{I}_{n}$ is $1/n$, $1/n$ is
the upper bound of the difference between the Born quantum probabilities
