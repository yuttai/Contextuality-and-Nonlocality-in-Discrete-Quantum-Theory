...
\end{equation}
Since each orthogonal basis can form an instance of Eq.~(\ref{eq:QuantumInterval-valuedProbability-Inclusion}),
the orthogonal bases in $\events_{18}$ gives the following equations:
\begin{equation}
