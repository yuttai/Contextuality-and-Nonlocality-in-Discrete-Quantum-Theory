...
This result will first be generalized in this section, and then we
will show some QIVPMs may not be induced by any quantum probability
measure, i.e., no state is consistent with these kind of QIVPMs.
...
to get $\bar{\mu}_{3}$. Replacing numbers by intervals containing
them can be generalized if we carefully pick a set of intervals and
the rule to select the correct interval when intervals are overlapping.
For example, consider the following collection of intervals: 
\begin{eqnarray}
...
two quantum probability measure~$\mu_{\mathbb{1}/3}^{\mathrm{B}}$
and $\mu_{\rho_{0}}^{\mathrm{B}}$ can induce two QIVPMs, where $\mathbb{1}/3=\left(\proj{0}+\proj{1}+\proj{2}\right)/3$
...
\begin{tabular}{ccccc}
\toprule 
$P$ & $\mu_{\mathbb{1}/3}^{\mathrm{B}}\left(P\right)$ & $\iota_{2}\left(\mu_{\mathbb{1}/3}^{\mathrm{B}}\left(P\right)\right)$ & $\mu_{\rho_{0}}^{\mathrm{B}}\left(P\right)$ & $\iota_{2}\left(\mu_{\rho_{0}}^{\mathrm{B}}\left(P\right)\right)$\tabularnewline
\midrule
\midrule 
$\mathbb{0}$ & $0$ & $\imposs$ & $0$ & $\imposs$\tabularnewline
\midrule 
$\proj{0}$ & $\frac{1}{3}$ & $\left[0,\frac{1}{2}\right]$ & $\frac{7}{24}$ & $\left[0,\frac{1}{2}\right]$\tabularnewline
\midrule 
$\proj{1}$ & $\frac{1}{3}$ & $\left[0,\frac{1}{2}\right]$ & $\frac{1}{3}$ & $\left[0,\frac{1}{2}\right]$\tabularnewline
\midrule 
$\proj{2}$ & $\frac{1}{3}$ & $\left[0,\frac{1}{2}\right]$ & $\frac{3}{8}$ & $\left[\tfrac{1}{4},\tfrac{3}{4}\right]$\tabularnewline
\midrule 
$\mathbb{1}-\proj{2}$ & $\frac{2}{3}$ & $\left[\frac{1}{2},1\right]$ & $\frac{5}{8}$ & $\left[\tfrac{1}{4},\tfrac{3}{4}\right]$\tabularnewline
\midrule 
$\mathbb{1}-\proj{1}$ & $\frac{2}{3}$ & $\left[\frac{1}{2},1\right]$ & $\frac{2}{3}$ & $\left[\frac{1}{2},1\right]$\tabularnewline
\midrule 
$\mathbb{1}-\proj{0}$ & $\frac{2}{3}$ & $\left[\frac{1}{2},1\right]$ & $\frac{17}{24}$ & $\left[\frac{1}{2},1\right]$\tabularnewline
\midrule 
$\mathbb{1}$ & $1$ & $\necess$ & $1$ & $\necess$\tabularnewline
\bottomrule
\end{tabular}
...
$\mathbb{1}/3$ and $\rho_{0}$ are both totally mixed states. Since
$\left\Vert \frac{\mathbb{1}}{3}-\rho_{0}\right\Vert \le\frac{1}{24}$,
