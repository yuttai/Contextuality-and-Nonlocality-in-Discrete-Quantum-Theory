...
\begin{fact}Let $\sigma\left(\rho-\rho'\right)$ denote the set of
eigenvalues of $\rho-\rho'$. Since $\rho$ and $\rho'$ are states,
they are Hermitian~\citep{544199}, and so does $\rho-\rho'$. In
this situation, $\left\Vert \rho-\rho'\right\Vert =\max\set{\left|\lambda\right|}{\lambda\in\sigma\left(\rho-\rho'\right)}$~\citep{544199}.\end{fact}
