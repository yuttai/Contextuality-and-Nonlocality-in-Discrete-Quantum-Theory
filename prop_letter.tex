...
\begin{eqnarray}
\necess & \subseteq & \bar{f}\left(P_{00}\right)+\bar{f}\left(P_{01}\right)\nonumber \\*
 &  & +\bar{f}\left(P_{10}\right)+\bar{f}\left(P_{11}\right)\textrm{ ,}\\
\necess & \subseteq & \bar{f}\left(P_{00}\right)+\bar{f}\left(P_{01}\right)\nonumber \\*
 &  & +\bar{f}\left(P_{1\ps}\right)+\bar{f}\left(P_{1\ms}\right)\textrm{ ,}\\
\necess & \subseteq & \bar{f}\left(P_{00}\right)+\bar{f}\left(P_{10}\right)\nonumber \\*
 &  & +\bar{f}\left(P_{\ps1}\right)+\bar{f}\left(P_{\ms1}\right)\textrm{ ,}\\
\necess & \subseteq & \bar{f}\left(P_{00}\right)+\bar{f}\left(P_{11}\right)\nonumber \\*
 &  & +\bar{f}\left(P_{\textrm{B}0}\right)+\bar{f}\left(P_{\textrm{B}1}\right)\textrm{ ,}\\
\necess & \subseteq & \bar{f}\left(P_{\textrm{N}3}\right)+\bar{f}\left(P_{\textrm{N}2}\right)\nonumber \\*
 &  & +\bar{f}\left(P_{\textrm{N}1}\right)+\bar{f}\left(P_{\textrm{N}0}\right)\textrm{ ,}\\
\necess & \subseteq & \bar{f}\left(P_{\textrm{N}3}\right)+\bar{f}\left(P_{\textrm{N}1}\right)\nonumber \\*
 &  & +\bar{f}\left(P_{\ps0}\right)+\bar{f}\left(P_{\ms1}\right)\textrm{ ,}\\
\necess & \subseteq & \bar{f}\left(P_{\textrm{N}2}\right)+\bar{f}\left(P_{\textrm{N}1}\right)\nonumber \\*
 &  & +\bar{f}\left(P_{\textrm{B}0}\right)+\bar{f}\left(P_{\textrm{B}3}\right)\textrm{ ,}\\
\necess & \subseteq & \bar{f}\left(P_{\textrm{N}1}\right)+\bar{f}\left(P_{\textrm{N}0}\right)\nonumber \\*
 &  & +\bar{f}\left(P_{1\ps}\right)+\bar{f}\left(P_{0\ms}\right)\textrm{ ,}\\
\necess & \subseteq & \bar{f}\left(P_{\textrm{B}1}\right)+\bar{f}\left(P_{\textrm{B}3}\right)\nonumber \\*
 &  & +\bar{f}\left(P_{\ps\ps}\right)+\bar{f}\left(P_{\ms\ms}\right)\textrm{ ,}\\
\necess & \subseteq & \bar{f}\left(P_{1\ms}\right)+\bar{f}\left(P_{0\ms}\right)\nonumber \\*
 &  & +\bar{f}\left(P_{\ps\ps}\right)+\bar{f}\left(P_{\ms\ps}\right)\textrm{ ,}\\
\necess & \subseteq & \bar{f}\left(P_{\ps0}\right)+\bar{f}\left(P_{\ps1}\right)\nonumber \\*
 &  & +\bar{f}\left(P_{\ms\ps}\right)+\bar{f}\left(P_{\ms\ms}\right)\textrm{ .}
\end{eqnarray}
\end{subequations}If we sum up Eq.~(\ref{eq:Kernaghan}), we will
have
\begin{eqnarray}
\left[11,11\right] & \subseteq & 4\bar{f}\left(P_{00}\right)+4\bar{f}\left(P_{\textrm{N}1}\right)\nonumber \\
 &  & +2\sum_{\ket{\psi}\in\mathcal{T}_{18}}\bar{f}\left(\ket{\psi}\right)\textrm{ ,}\label{eq:QuantumInterval-valuedProbability-Total}
\end{eqnarray}
where 
\begin{eqnarray}
\mathcal{T}_{18} & = & \mathcal{T}_{24}\backslash\{\left(P_{00}\right),\left(P_{\textrm{N}1}\right),\left(P_{\ps\ms}\right),\nonumber \\
 &  & \left(P_{\ms0}\right),\left(P_{\textrm{B}2}\right),\left(P_{0\ps}\right)\}\textrm{ .}
\end{eqnarray}
