...
% \end{enumerate}
% }
\yutsung{Still not comfortable about the current statement... Notice
that the key properties of the non-contextual hidden variable theory
used in our Mermin-Peres square proof is
\begin{itemize}
