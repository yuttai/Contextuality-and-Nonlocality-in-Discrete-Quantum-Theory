...
$\mathbf{O} = \proj{0} + 2\,\proj{1} + 3\,\proj{2}$, i.e., $\lambda_{i}=j$ and $P_{i}=\proj{j-1}$.
...
behavior. To illustrate the example easier, we restrict ourselves
...
This result will first be generalized in this section, and introduce
a finite-precision extension of the Born rule~\citep{peres1995quantum,544199,Jaeger2007}.
The Born rule is essential to compute the conventional quantum probability
...
\begin{thm}[Non-extensible of Gleason's theorem to general QIVPMs]In
...
basis $\left\{ \ket{0},\ket{1},\ket{2}\right\} $, let $\mathscr{I}_{0}=\left\{ \necess,\imposs,\unknown\right\} $,
