...
\yutsung{About contextuality or non-contextuality, summarize the
existence and non-existence of $\delta$-deterministic QIVPMs in Fig.~\ref{fig:contextuality-non-contextuality}.}
\begin{figure*}
\[
\xymatrix{ & \delta=0 &  & \delta=\frac{1}{3} & \delta=1\\
\textrm{Classical IVPMs} & \ar[rrr] &  &  & \,\\
\textrm{Instance} & \bar{\mu}_{4} &  & \bar{\mu}_{5},\bar{\mu}_{6} & \bar{\mu}_{2},\textrm{ every classical IVPM}\\
\textrm{Interpertation} & \textrm{D Classical Theory} &  & \textrm{P Classical Theory?} & \textrm{P Classical Theory?}\\
\textrm{QIVPMs} & \ar@2{|-|}[rr]_{\textrm{NE by Thm. \ref{cor:Kochen-Specker-IVPM}}}\ar[rrr] &  &  & \,\\
\textrm{Instance} & \textrm{NE by Thm. }\ref{thm:Kochen-Specker} &  & \iota_{\infty}\circ\mu_{\mathbb{1}/3}^{\mathrm{B}} & \bar{\mu}_{1},\bar{\mu}_{3}\textrm{, every QIVPM}\\
\textrm{Interpertation} & \textrm{NEDNCHVT}\ar@{}[rr]|-{\textrm{NEPNCHVT?}} &  & \textrm{EPNCHVT?} & \textrm{EPNCHVT?}
}
\]
\caption{\label{fig:contextuality-non-contextuality}The figure summarize the
existence and non-existence of $\delta$-deterministic classical IVPMs
and QIVPMs. In the figure, ``D'' denotes ``deterministic,'' P
denotes ``probabilitic,'' ``(N)E'' denotes ``(Non-)Exist,''
``(N)C'' denotes ``(Non-)Contextuality,'' and HVT denotes ``Hidden-Variable
Theory.''}
\end{figure*}
