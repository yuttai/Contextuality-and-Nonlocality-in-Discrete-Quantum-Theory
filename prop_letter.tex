...
\begin{table}
\caption{\label{tab:I_n}Intervals in $\mathscr{I}_{n}$, their interior, and
their length, where $2\mid k$ means $k$ is even, and $2\nmid k$
...
\toprule 
\addlinespace
$k$ & $[\ell,r]$ & $\textrm{Int}\left([\ell,r]\right)$ & $r-\ell$\tabularnewline\addlinespace
\midrule
\midrule 
\addlinespace
 & $\imposs$ & $\imposs$ & $0$\tabularnewline\addlinespace
\midrule 
\addlinespace
$0$ & $\left[0,\tfrac{1}{2n}\right]$ & $\left(0,\tfrac{0.5}{2n}\right]$ & $\tfrac{1}{2n}$\tabularnewline\addlinespace
\midrule 
\addlinespace
\begin{tabular}{c}
$0<k<2n$\tabularnewline
and $2\nmid k$\tabularnewline
\end{tabular} & $\left[\tfrac{k-1}{2n},\tfrac{k+1}{2n}\right]$ & $\left(\tfrac{k-0.5}{2n},\tfrac{k+0.5}{2n}\right)$ & $\tfrac{1}{n}$\tabularnewline\addlinespace
\midrule 
\addlinespace
\begin{tabular}{c}
$0<k<2n$\tabularnewline
and $2\mid k$\tabularnewline
\end{tabular} & \multirow{1}{*}{$\left[\tfrac{k-1}{2n},\tfrac{k+1}{2n}\right]$} & \multirow{1}{*}{$\left[\tfrac{k-0.5}{2n},\tfrac{k+0.5}{2n}\right]$} & $\tfrac{1}{n}$\tabularnewline\addlinespace
\midrule 
\addlinespace
$2n$ & $\left[\tfrac{2n-1}{2n},1\right]$ & $\left[\tfrac{2n-0.5}{2n},1\right)$ & $\tfrac{1}{2n}$\tabularnewline\addlinespace
\midrule 
\addlinespace
 & $\necess$ & $\necess$ & $0$\tabularnewline\addlinespace
\bottomrule
\end{tabular}
\end{table}
...
\begin{table}
\caption{\label{tab:I_2}Intervals in $\mathscr{I}_{2}$, their interior, and
their length. Although intervals~$[\ell,r]$ are overlapping, their
interior~$\textrm{Int}\left([\ell,r]\right)$ are non-overlapping.}
...
\midrule 
\addlinespace
$0$ & $\left[0,\tfrac{1}{4}\right]$ & $\left(0,\tfrac{1}{8}\right]$ & $\tfrac{1}{4}$\tabularnewline\addlinespace
\midrule 
\addlinespace
$1$ & $\left[0,{\textstyle \tfrac{1}{2}}\right]$ & $\left(\tfrac{1}{8},\tfrac{3}{8}\right)$ & $\tfrac{1}{2}$\tabularnewline\addlinespace
\midrule 
\addlinespace
$2$ & $\left[\tfrac{1}{4},\tfrac{3}{4}\right]$ & $\left[\tfrac{3}{8},\tfrac{5}{8}\right]$ & $\tfrac{1}{2}$\tabularnewline\addlinespace
\midrule 
\addlinespace
$3$ & $\left[\tfrac{1}{2},1\right]$ & $\left(\tfrac{5}{8},\tfrac{7}{8}\right)$ & $\tfrac{1}{2}$\tabularnewline\addlinespace
\midrule 
\addlinespace
$4$ & $\left[\tfrac{1}{4},1\right]$ & $\left[\tfrac{7}{8},1\right)$ & $\tfrac{1}{4}$\tabularnewline\addlinespace
\midrule 
\addlinespace
 & $\necess$ & $\necess$ & $0$\tabularnewline\addlinespace
\bottomrule
...
can be deduced easily~\citep{HOSTunpublished}. Therefore, $\iota_{n}\circ\mu_{\rho}^{\mathrm{B}}$
is indeed a QIVPM. 
...
Born QIVPMs]In a Hilbert space $\Hilb$ of dimension $3$, given
any totally mixed state~$\rho$, 
\begin{equation}
...
$\left\Vert \rho-\rho'\right\Vert $, must be bounded by $1/n$ which
is the maximal length of the intervals in $\mathscr{I}_{n}$~\citep{HOSTunpublished}.
Conversely, if the distance between $\rho$ and $\rho'$ is bounded
by $\frac{1}{12n}$, their Born quantum probability on any projector~$P$
is $\left|\mu_{\rho_{0}}^{\mathrm{B}}\left(P\right)-\mu_{\rho_{1}}^{\mathrm{B}}\left(P\right)\right|\le\frac{1}{4n}$~\citep{HOSTunpublished}.
Moreover, the interiors of the intervals in $\mathscr{I}_{n}$ shrinks
$\frac{0.5}{2n}$ from the both ends, excepts $\imposs$, $\left[0,\tfrac{1}{2n}\right]$,
$\left[\tfrac{2n-1}{2n},1\right]$, and $\necess$. Together with
the fact that $0<\mu_{\rho_{0}}^{\mathrm{B}}\left(P\right)<1$ and
$0<\mu_{\rho_{1}}^{\mathrm{B}}\left(P\right)<1$, $\mu_{\rho_{0}}^{\mathrm{B}}\left(P\right)$
...
For example, we should have $\rho_{1}\in\coreBorn\left(\widehat{\iota}_{2}\circ\mu_{\rho_{0}}^{\mathrm{B}},\events\right)$
