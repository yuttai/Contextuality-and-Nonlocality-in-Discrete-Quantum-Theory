...
observable with respect to the consistent states. Formally speaking,
...
we have
\[
\expval{\mathbb{0}}_{\bar{\mu}_{1}}=\left[0,0\right]\ne\left[-2,2\right]=\expval{\sigma_{\mathrm{z}}}_{\bar{\mu}_{1}}+\expval{-\sigma_{\mathrm{z}}}_{\bar{\mu}_{1}}
\]
