...
\emph{convexity}~\cite{Shapley1971,GilboaSchmeidler1994,NgMoYeh1997,Marinacci1999,Grabisch2016},
...
\emph{Choquet integral}~\citep{Choquet1954,GilboaSchmeidler1994,Grabisch2016}
...
and~\ref{enu:iota-mu-QIVPM} as we have outlined above. For the quantum case, we want
...
$\ultramodular$ is not ultramodular, consider the commuting subspace of
event~$\events_{\mathrm{C}}$ generated by $\proj{0}$, $\proj{1}$, $\proj{2}$,
and $\proj{3}$, and then state~$\rho$ defined previously. Then, restricting
$\mu_{\rho}^{\mathrm{\mathrm{B}}}$ to $\events_{\mathrm{C}}$,
$\mu_{\rho}^{\mathrm{\mathrm{B}}}|_{\events_{0}}$, gives a classical probability
measure $\mu:\events_{\mathrm{C}}\rightarrow\left[0,1\right]$. By the same
reason as the quantum case, the induced map $\ultramodular\circ\mu$ fails to be
a classical IVPM.
