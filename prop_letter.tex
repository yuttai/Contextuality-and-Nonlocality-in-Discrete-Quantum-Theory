...
the null event and $\Omega$ is the event covering the entire
...
\yutsung{Need to be rewrite and make it more clear. Say with symbol and
equation is better.}
...
\yutsung{Redefine $\bar{\mu}$ to be more clear!}
