...
In other words, the set of all quantum probability measures corresponds
...
in just applying error analysis in experimental results, but it highlights
...
Eqs.~(\ref{eq:QIVPM-constraints}), the condition really needing
to be checked is Eq.~(\ref{eq:QuantumInterval-valuedProbability-Inclusion}).
