...
\end{thm}
In contrast, when $d=2$, consider ${\cal P}:\C^{2*}\rightarrow\left[0,1\right]$
such that if we restrict ${\cal P}$ on the real unit circle, we will
have a discontinuous function 
\[
{\cal P}
...
Third, even if we require the range of $\hat{\pi}$ has a group structure,
we still may not find $\dpr_{\Psi}=\hat{\pi}$.
%%%%%%%%%%%%%%%%%
