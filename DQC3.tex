...
the discrete Born rule $\dpr\left(\ket{\Psi},\ket{i}\right)$ will
be written in the curried form $\dpr_{\Psi}\left(\ket{i}\right)$.
Then, we have 
\begin{thm}
...
\end{eqnarray}
such that $\dpr_{\Psi}\ne\hat{\pi}$ for any $\ket{\Psi}\in\ffzd{p^{2}}$.\end{thm}
\begin{proof}
