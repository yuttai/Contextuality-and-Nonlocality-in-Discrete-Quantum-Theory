...
other? According to the postulates in page 207 in Peres~\cite{peres1995quantum},
...
Let $v\left(\mathbf{O}\right)$ be the predetermined definite outcome
of an observable $\mathbf{O}$, then we can define $v'$ on states
by their projector $v'\left(\ket{n}\right)=v\left(\proj{n}\right)$.
Because lack of commuting observables in Schumacher and Westmoreland~\cite{2010arXiv1010.5452S},
they use ``$v'$ is well-defined'' as the definition of non-contextuality.

Besides, if the result of measuring an observable depends on simultaneously
measuring commuting observables, then the usual slogan ``two commuting
operators can be simultaneously measured'' is just confusing... }
