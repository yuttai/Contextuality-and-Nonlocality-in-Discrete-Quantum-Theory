...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{\label{sec:Critical-Analysis-CQT}Critical Analysis of the Measurement
Process in CQT}
...
an extra property
\begin{description}
\item [{(iv)}] $\dpt(\ket{\Phi},\ket{\Psi})=\dpt(\lambda\ket{\Phi},\ket{\Psi})=\dpt(\ket{\Phi},\lambda\ket{\Psi})$
where $\lambda\in\ff{p^{2}}^{*}$. 
\end{description}
...
\yutsung{The Born rule is the \emph{only}
