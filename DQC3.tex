...
a probability. Everyone who tried to build a quantum theory over finite
fields struggled on how to define a reasonable probability. If Gleason's
theorem works in any sense over finite fields, we can have a reasonable
way to induce the Born rule over finite fields.
