...
Gleason's theorem. 
\begin{suggest}{\andy}{2}[use PLURAL, ball -> balls, and then, to me, it would
...
text)  the several statements around Eqs.~(\ref{eq:QIVPM-constraints}) as axioms, or use
