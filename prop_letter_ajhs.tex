...
%% ajh - SUGGESTED INTRO SENTENCE: TEXT #0 would go here.
...
%% ajh -  LONG SUGGESTED TEXT #1 would go here
...
%% ajh: Inverted logic: LONG SUGGESTED TEXT #3 would go here
...
%% ajh: big problems here: LONG SUGGESTED TEXT #5 would go here.  To
...
%% this ..." and replace all the way to Eq (9) by LONG SUGGESTED TEXT
%% #6,  which coherently introduces the "core" and sets if off as a
%% DEFINITION, etc. 
...
%% replacement: LONG SUGGESTED TEXT #7, I would state FIRST that 'here
...
%%   LONG SUGGESTED TEXT #8 would go here
