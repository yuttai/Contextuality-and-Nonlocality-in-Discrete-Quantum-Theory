...
estimated by the relative frequency~$\frac{3}{8}$. Generally, the probability of
the event that exactly $M$ needles out of the $N$ total needles cross lines can
be estimated by the relative frequency~$\frac{M}{N}$.

In an actual experiment with $500$ needles and the ratio
$\frac{\ell}{h}=0.75$~\cite{Hall1873}, it was found that $236$ 
crossed a line so the relative frequency is $0.472$ comparing 
the values to the idealized mathematical probability $0.4775\ldots$. In a larger 
experiment with $5000$ needles and the ratio $\frac{\ell}{h}=0.8$~\cite{Uspensky1937}, 
the relative frequency was calculated to be $0.5064$ comparing 
the values to the idealized mathematical probability $0.5093\ldots$. We see that 
the observed probability approaches $\frac{2\ell}{\pi h}$ but only if
...
of the event and its plausibility. In another experiment with
$3204$ needles and the ratio $\frac{\ell}{h}=0.6$~\cite{DeMorgan1872}, 
there are $1213$ needles clearly crossed a line and $11$ ones
...
$\left[\frac{1213}{3204},\frac{1224}{3204}\right]$ expressing that we are
certain that the event has probability at least $\frac{1213}{3204}$ but it is possible that
it would have probability $\frac{1224}{3204}$.
...
~\cite{10.2307/2308516,Redhead1987-REDINA,peres1995quantum,Swart2013}]
Given a Hilbert space $\Hilb$, an event, formally called elementary quantum
test~\cite{peres1995quantum}, can be represented as a projection operator
$P:\Hilb\rightarrow\Hilb$ onto a linear subspace~$S$ of $\Hilb$. The set of all
...
\item For any vector $\ket{\psi}\in \Hilb$,
  $\frac{\proj{\psi}}{\ip{\psi}{\psi}}$ is a projection.
...
Notice that the preceding definition exhaust all possible projection operators.
