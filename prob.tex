...
$\ell$. We throw the $N$ needles and observe the number $X$ of needles
that cross a line. The sample space can be expressed as the set
$(X|-)^N$
...
cross lines is $\{-XX,X-X,XX-\}$: it has
...
information \emph{against} the event (i.e., information about the dual
