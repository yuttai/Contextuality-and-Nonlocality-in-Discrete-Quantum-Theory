...
split the $[0,1]$ interval into a collection of closed sub-intervals
obeying certain restrictions to be described at the end of the
section. To illustrate the main ideas, we first consider a simple
example. 
...
\end{itemize}
The probability measure in this case becomes:
\[
\begin{array}{c@{\qquad\qquad}c}
\begin{array}{rcl}
\pmeas(\emptyset) & = & \imposs\\
...
to be heads than tails, despite the absence of numeric information.
\qed\end{example}
