...
$h$. and the needles lengths are not all equal and are not all
...
\begin{definition}[Projection Operators; Orthogonality~\cite{BirkhoffVonNeumann1936,10.2307/2308516,Redhead1987-REDINA,peres1995quantum,Swart2013}]
Given a Hilbert space $\Hilb$, an eventt\footnote{An event is formally called an experimental proposition~\cite{BirkhoffVonNeumann1936},
a question~\cite{10.2307/2308516}, or an elementary quantum test~\cite{peres1995quantum}} can be represented as a projection operator
...
\begin{definition}[Commutativity~\cite{Redhead1987-REDINA,peres1995quantum,Swart2013}]
...
\begin{definition}[Quantum Probability Space~\cite{10.2307/2308516,gleason1957,Redhead1987-REDINA,DBLP:journals/corr/abs-0910-2393,Maassen2010}]
