...
is known a priori. In reality, the probability of each event is assumed
to exist although the exact value of $\pmeas(E)$ may not be known.
...
satisfies
\[
\ip{\phi}{0}=\ip{\phi}{\ps}=\ip{\phi}{\ps'}=0
\]
