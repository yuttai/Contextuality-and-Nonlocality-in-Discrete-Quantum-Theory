...
Instead of $\left[0,1\right]$, we will consider set-valued probability
measures~\cite{Artstein1972,PuriRalescu1983}, in particular $\left\{ 0\right\} $,
...
\hline 
$\ffzd{p^{2}}$for $d\ge3$ except $d=p=3$ & $\left[0,1\right]$  & $\ge1$ & No & $0$ & \tabularnewline
\hline 
