...
on nonzero vector~$\ket{\psi}$ by $f\left(\ket{\psi}\right)=\left\Vert \ket{\psi}\right\Vert ^{2}f\left(\left\Vert \ket{\psi}\right\Vert ^{-1}\ket{\psi}\right)$
and its unique extension to the whole space~\cite{RichmanBridges1999}.\qed\end{definition}
...
\item $f'\left(\ket{\psi}\right)=f\left(\ket{\psi}\right)-Q\left(\ket{\psi}\right)$.
\end{itemize}
Then, $\left|Q\left(\ket{\psi}\right)-f\left(\ket{\psi}\right)\right|\le27\delta\left(W_{r}-W_{l},W_{r}-W_{l},\omega_{f}\right)+27\delta\left(W_{r}-W_{l},W_{r}-W_{l},\omega_{f'}\right)+18\left(W_{r}-W_{l}\right)$.\qed\end{lemma}
