...
\item for mutually orthogonal projections $\left\{ P_{i}\right\} _{i=1}^{N}$,
...
matrix~$\rho=\sum_{j=1}^{N}q_{j}\proj{\phi_{j}}$, where $\sum_{j=1}^{N}q_{j}=1$.
...
and $\iota\left(\sideset{_{\mathbb{R}}}{_{i=1}^{N}}\sum x_{i}\right)\subseteq\sideset{_{\mathscr{I}}}{_{i=1}^{N}}\sum\iota\left(x_{i}\right)$,
where $x$ and $\sideset{_{\mathbb{R}}}{_{i=1}^{N}}\sum x_{i}\in\left[0,1\right]$.
