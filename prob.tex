...
resources~\cite{Artin1991,Wechler1992,PurdomBrown1995,DummitFoote2004}. The
...
can interpret impossible as the closed interval $[0]$, possible as the
open interval $(0,1]$, and $\vee$ as the union of intervals. The
...
The equalivance between 2. and 3. can be found
in Proposition 4.1.1 in \cite{Swart2013}. Notice that this proposition
holds for every dimension... So it is not exactly Gleason's theorem,
or at least not the main part of the Gleason's theorem...}
