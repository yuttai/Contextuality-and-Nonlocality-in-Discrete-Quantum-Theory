...
maps a linear space to its projection operator. Since the non-additivity
operator~$\mathfrak{D}\left(S_{1},S_{2}\right)$ is non-zero when
$S_{1}$ and $S_{2}$ does not commute. 
