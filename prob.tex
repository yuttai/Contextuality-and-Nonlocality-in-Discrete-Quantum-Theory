...
measures consists the lower probability (belief) as the left-end and
the upper probability (plausibility) as the right-end~\cite{GilboaSchmeidler1994,Marinacci1999,Goodman2013,Teran2014}.
They are defined by Dempster~\cite{Dempster1967} and Shafer~\cite{Shafer1976}
and play an important role in the theory of non-additive belief.\footnote{\yutsung{If we want to use convex, we need to explain the physical
