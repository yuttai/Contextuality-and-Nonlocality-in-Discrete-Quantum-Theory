...
vector space spanned by $\ket{0}$, $\ket{\bar{0}'}=\ket{\bar{0}}\frac{\ip{2}{\psi}}{\ip{0}{\psi}}$,
$\ket{\psi'}=\ket{\psi}\frac{\left|\ip{0}{\psi}\right|}{\ip{0}{\psi}}$,
and denote its unit sphere as $S^{2}$. Then, 
\begin{eqnarray*}
f\left(\ket{0}\right)=\max_{\ket{\phi}\in\mathbb{C}S^{2}}f\left(\ket{\phi}\right)\ge\max_{\ket{\phi}\in S^{2}}f\left(\ket{\phi}\right)\ge f\left(\ket{0}\right) & \Rightarrow & \max_{\ket{\phi}\in S^{2}}f\left(\ket{\phi}\right)=f\left(\ket{0}\right)\\
...
And let 
\begin{eqnarray*}
\ket{2'} & = & \sigma_{\ket{0}\times\ket{\bar{0}'}}\ket{0}=\frac{\left(\ket{0}\times\ket{\bar{0}}\frac{\ip{2}{\psi}}{\ip{0}{\psi}}\right)\times\ket{0}}{\left\Vert \left(\ket{0}\times\ket{\bar{0}}\frac{\ip{2}{\psi}}{\ip{0}{\psi}}\right)\times\ket{0}\right\Vert }=\sigma_{\ket{0}\times\ket{\bar{0}}}\ket{0}\frac{\left|\ip{0}{\psi}\right|}{\ip{0}{\psi}}\frac{\ip{2}{\psi}}{\left|\ip{2}{\psi}\right|}=\ket{2}\frac{\left|\ip{0}{\psi}\right|}{\ip{0}{\psi}}\frac{\ip{2}{\psi}}{\left|\ip{2}{\psi}\right|}\overset{?}{\in}S^{2}\\
\ket{1'} & = & \ket{1}\frac{\left|\ip{0}{\psi}\right|}{\ip{0}{\psi}}\frac{\ip{1}{\psi}}{\left|\ip{1}{\psi}\right|}\overset{?}{\in}S^{2}
\end{eqnarray*}
\begin{eqnarray*}
 &  & \left|Q\left(\ket{\psi}\right)-f\left(\ket{\psi}\right)\right|\\
...
\begin{itemize}
\item $M=\max_{\ket{\psi}\in\mathbb{C}S^{2}}f\left(\ket{\psi}\right)=f\left(\ket{0}\right)$, 
\item $m=\min_{\ket{\psi}\in\mathbb{C}S^{2}}f\left(\ket{\psi}\right)=f\left(\ket{\bar{0}}\right)$, 
\item $\ket{2}=\sigma_{\ket{0}\times\ket{\bar{0}}}\ket{0}$, $\ket{1}=\ket{2}\times\ket{0}$, 
