...
\item for any event $E$, $\pmeas\left(\Omega\backslash
E\right)=1\tensor*[_{\mathscr{I}}]{-}{}\pmeas\left(E\right)$, and 
...
Space~\cite{10.2307/2308516,gleason1957,Redhead1987-REDINA,Maassen2010}]\label{def:QuantumProbabilitySpace}
  ...
  $\tensor*[_{[0,1]}]{\mu}{} : \events \rightarrow [0,1]$ such
...
\begin{itemize}
\item $\tensor*[_{[0,1]}]{\mu}{}(\mathbb{1})=1$, and 
\item for mutually orthogonal projections $P_{i}$, we have 
$\tensor*[_{[0,1]}]{\mu}{}\left(\tensor*[_{\mathscr{O}}]{\sum}{_{i}}P_{i}\right)=\tensor*[_{\mathbb{R}}]{\sum}{_{i}}\tensor*[_{[0,1]}]{\mu}{}\left(P_{i}\right)$.
\end{itemize}
Notice that the preposing $[0,1]$ indicates the range of
$\tensor*[_{[0,1]}]{\mu}{}$. We will only prepose the range of a
probability measure whenever we need to compare the ranges of different
probability measures later. 
\qed\end{definition}
...
probability measure} is a function~$\tensor*[_{\mathscr{I}}]{\mu}{}:\events\rightarrow\mathscr{I}$
such that: 
\begin{itemize}
\item $\tensor*[_{\mathscr{I}}]{\mu}{}(\mathbb{0})=\left[0,0\right]$, 
\item $\tensor*[_{\mathscr{I}}]{\mu}{}(\mathbb{1})=\left[1,1\right]$, 
\item for any projection $P$,
$\tensor*[_{\mathscr{I}}]{\mu}{}\left(\mathbb{1}\tensor*[_{\mathscr{O}}]{-}{}P\right)=1\tensor*[_{\mathscr{I}}]{-}{}\tensor*[_{\mathscr{I}}]{\mu}{}\left(P\right)$, and
\item for a set of mutually orthogonal projections $P_{i}$, we have
$\tensor*[_{\mathscr{I}}]{\mu}{}\left(\tensor*[_{\mathscr{O}}]{\sum}{_{i}}P_{i}\right)\subseteq\tensor*[_{\mathscr{I}}]{\sum}{_{i}}\tensor*[_{\mathscr{I}}]{\mu}{}\left(P_{i}\right)$.
\end{itemize}
...
\end{eqnarray*}
$\mu$ is not a quantum interval-valued probability measure. To verify
...
\begin{eqnarray*}
 &  & \mu\left(\proj{\psi_{0}}+\proj{\psi_{1}}\right)=\mu\left(1-\proj{\psi_{2}}\right)=\unknown\\
 & \nsubseteq & \imposs+\imposs=\mu\left(\proj{\psi_{1}}\right)+\mu\left(\proj{\psi_{2}}\right)\textrm{ .}
\end{eqnarray*}
\qed\end{example}
