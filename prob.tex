...
by
\[
g_{f,\ket{0}}\left(\ket{\psi}\right)=f\left(\ket{\psi}\right)+f\left(\ket{0}\times\ket{\psi}\right)\textrm{ .}
\]
Notice that $\ket{0}\times\ket{\psi}$ is the vector~$\ket{\psi}$
clockwise-rotated by $\frac{\pi}{2}$ about $\ket{0}$.\qed\end{definition}
...
\item $\ket{2}=\left(\ket{0}\times\ket{\bar{0}}\right)\times\ket{0}$, $\ket{1}=\ket{2}\times\ket{0}$, 
...
for all $\ket{\psi}\in S^{2}$.\qed\end{thm}
\begin{proof}
Let $\ket{\bar{2}}=\left(\ket{0}\times\ket{\bar{0}}\right)\times\ket{\bar{0}}$.
Then 
\[
...
\begin{eqnarray*}
\ket{0}\times\left(x,y,z\right) & = & \left(x,-z,y\right)\\
\ket{2}\times\left(x,y,z\right) & = & \left(-y,x,z\right)
\end{eqnarray*}
Note that 
\begin{eqnarray*}
Q\left(\ket{\psi}\right)+Q\left(\ket{0}\times\ket{\psi}\right) & = & 2Mx^{2}+\left(W-M\right)\left(y^{2}+z^{2}\right)\\
Q\left(\ket{\psi}\right)+Q\left(\ket{2}\times\ket{\psi}\right) & = & 2mz^{2}+\left(W-m\right)\left(x^{2}+y^{2}\right)
\end{eqnarray*}
...
we should have 
\begin{eqnarray*}
\left|f'\left(\ket{\psi}\right)+f'\left(\ket{0}\times\ket{\psi}\right)\right| & = & \left|g_{f,\ket{0}}-\left(2Mx^{2}+\left(W-M\right)\left(y^{2}+z^{2}\right)\right)\right|\le9\delta\left(0,W_{r}-W_{l},\omega_{f}\right)+3\left(W_{r}-W_{l}\right)\\
\left|f'\left(\ket{\psi}\right)+f'\left(\ket{2}\times\ket{\psi}\right)\right| & = & \left|g_{f,\ket{2}}-\left(2mz^{2}+\left(W-m\right)\left(x^{2}+y^{2}\right)\right)\right|\le9\delta\left(W_{r}-W_{l},W_{r}-W_{l},\omega_{f}\right)+3\left(W_{r}-W_{l}\right)
\end{eqnarray*}
...
where the last inequality holds because $\ket{i}\frac{\left|\ip{0}{\psi}\right|}{\ip{0}{\psi}}\frac{\ip{i}{\psi}}{\left|\ip{i}{\psi}\right|}\in\mathbb{C}S^{1}$
is orthogonal to $\ket{0}$, $\bra{0}\left(\frac{\left|\ip{0}{\psi}\right|}{\ip{0}{\psi}}\ket{\psi}\right)=1\in\mathbb{R}$,
and 
\[
\left(\ket{1}\frac{\left|\ip{0}{\psi}\right|}{\ip{0}{\psi}}\frac{\ip{1}{\psi}}{\left|\ip{1}{\psi}\right|}\right)^{\dagger}\left(\frac{\left|\ip{0}{\psi}\right|}{\ip{0}{\psi}}\ket{\psi}\right)=\frac{\ip{\psi}{1}}{\left|\ip{\psi}{1}\right|}\frac{\left|\ip{\psi}{0}\right|}{\ip{\psi}{0}}\bra{1}\frac{\left|\ip{0}{\psi}\right|}{\ip{0}{\psi}}\ket{\psi}\in\mathbb{R}\textrm{ .}
