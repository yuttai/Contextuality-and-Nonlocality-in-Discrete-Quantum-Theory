...
between additivity of Kolmogorov and quantum probabilities. The additivity
property of Kolmogorov probabilities 
\[
\delta\left(A,B\right)=q\left(A\vee B\right)-q\left(A\right)-q\left(B\right)+q\left(A\wedge B\right)=0\textrm{ ,}
\]
where $A$ and $B$ are events, and $q\left(A\right)$ is the probability
of $A$. Its quantum counterpart is 
\[
\mathfrak{D}\left(H_{1},H_{2}\right)=\Pi\left(H_{1}\vee H_{2}\right)-\Pi\left(H_{1}\right)-\Pi\left(H_{2}\right)+\Pi\left(H_{1}\wedge H_{2}\right)\textrm{ ,}
\]
