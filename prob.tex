...
example~\ref{ex1}. In general, a \emph{core} of an interval-valued
probability measure~$\bar{\mu}:\events\rightarrow\mathscr{I}$ is
a set of real-valued probability measures~$\pmeas:\events\rightarrow[0,1]$
such that $\pmeas\left(E\right)\in\bar{\mu}\left(E\right)$ for all
$E\in\events$~\cite{GilboaSchmeidler1994,Marinacci1999,Teran2014}.
