...
example~\ref{ex:three-dimensional-three-value} is highly likely
to serve as an counterexample for discrete interval-valued Gleason's
theorem...
...
to do thing correct, we should work on quantum (real/interval)-valued
...
don't know whether it works or not... Might need to put some strange
conditions to by-pass the counterexample corresponding to example~\ref{ex:three-dimensional-three-value}.
