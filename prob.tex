...
between events. 
\item \yutsung{The definition of independence is difference from difference
source:\\
1. In~\cite{Swart2013}, given two algebras~$\mathscr{B}_{1}$ and
$\mathscr{B}_{2}$ which commute with each other. They are \emph{logically
independent} if for all state~$\rho_{1}$ on $\mathscr{B}_{1}$ and
$\rho_{2}$ on $\mathscr{B}_{2}$, there is a unique state~$\rho$
on $\mathscr{B}_{1}\otimes\mathscr{B}_{2}$ such that $\rho\left(B_{1}\otimes B_{2}\right)=\rho_{1}\left(B_{1}\right)\rho_{2}\left(B_{2}\right)$
for all $B_{1}\in\mathscr{B}_{1}$ and $B_{2}\in\mathscr{B}_{2}$,
which denoted by $\rho_{1}\otimes\rho_{2}$. Notice that we require
$\mathscr{B}_{1}$ and $\mathscr{B}_{2}$ commute, and this definition
doesn't depend on a particular $\rho$. Then, logically independence
is used to defined the Bell inequality.\\
2. In~\cite{Yuan2012}, given a $\rho$ on an algebra~$\mathscr{C}$,
two sub-algebra $\mathscr{B}_{1}$ and $\mathscr{B}_{2}$ are independent
if $\rho\left(B_{1}B_{2}\right)=\rho\left(B_{1}\right)\rho\left(B_{2}\right)$
for all $B_{1}\in\mathscr{B}_{1}$ and $B_{2}\in\mathscr{B}_{2}$.
Notice that we doesn't require $\mathscr{B}_{1}$ and $\mathscr{B}_{2}$
commute, and this definition depend on a particular $\rho$.\\
3. In~\cite{GuehneKleinmannCabelloEtAl2010}, let $A$, $B$ be compatible
observables in a hidden variable model......................\\
}
\end{itemize}
\qed\end{definition}
