...
corresponding to $\ket{0}$ and $\ket{1}$. In reality, the local
field strength cannot prefect directs to to the $z$-axis, and all
atoms come from a hot oven cannot have the same velocity. The variant
of velocity makes spots broader and more washed out so that it may
sometimes hard to decide a particle corresponding to which state\footnote{\yutsung{Citation here?}}.
...
probability~$\left[l,r\right]$. About the imperfect direction of
field strength, we might take it into account when we introduce the
discrete quantum theory later.
