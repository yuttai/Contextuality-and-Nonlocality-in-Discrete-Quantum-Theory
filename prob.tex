...
probability measure~$\mu':\events\rightarrow\mathscr{I}$ by $\mu'\left(E\right)=\left[\mu\left(E\right),\mu\left(E\right)\right]$.
...
\begin{example}[Totally ignorant quantum interval-valued probability
measure] For any Hilbert space and intervals\emph{~$\mathscr{I}=\left\{ \left[0,0\right],\left[0,1\right],\left[1,1\right]\right\} $},
consider $\mu:\events\rightarrow\mathscr{I}$ defined as follow: 
\[
\mu(E)=\begin{cases}
\left[1,1\right] & \textrm{, if }E=\mathbb{1}\textrm{ ;}\\
\left[0,0\right] & \textrm{, if }E=\mathbb{0}\textrm{ ;}\\
\left[0,1\right] & \textrm{, otherwise.}
\end{cases}
\]
It is easy to verify $\mu$ is a quantum \emph{$\mathscr{I}$}-interval-valued
probability measure.\qed\end{example}
