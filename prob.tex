...
that perspective. However, if we attempt to understand the probability
measure independently of Ex.~\ref{ex1} we would hard pressed to
justify the following assignments:
\[ 
...
is in the range $[1,1]$! To understand this mystery, it is important
to investigate the mathematical definition of interval-valued
...
$E$. If we define $1-\left[a,b\right]=\left[1-b,1-a\right]$, then we
intuitively have
\begin{eqnarray*}
