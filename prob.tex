...
\item Projection operators $P_1$ and $P_2$ are orthogonal if $P_1P_2 =
  P_2P_1 = \mathbb{0}$. The sum of two orthogonal projections~$P_{1}\tensor*[_{\mathscr{O}}]{+}{}P_{2}$
is also a projection, where the preposing subscript $\mathscr{O}$
means $\tensor*[_{\mathscr{O}}]{+}{}$ is an operation between operators,
and may be dropped when there is no ambiguity. \\
\yutsung{Need to prove: \\
The sum of two projection operators~$P_{1}\tensor*[_{\mathscr{O}}]{+}{}P_{2}$
...
\begin{definition}[Complement; Commutativity;
Independence~\cite{peres1995quantum,Griffiths2003}]~
\begin{itemize}
\item If $P$ is a projection operator, then $\mathbb{1}\tensor*[_{\mathscr{O}}]{-}{}P$
is also a projection operator. It is orthogonal to $P$, $\mu\left(\mathbb{1}\tensor*[_{\mathscr{O}}]{-}{}P\right)=1\tensor*[_{\mathbb{R}}]{-}{}\mu\left(P\right)$,
and it corresponds to the complement event~$\Omega\backslash E$
in classical probability.
\item Projection operators $P_{1}$ and $P_{2}$ commute if $P_{1}P_{2}=P_{2}P_{1}$.
If the projections $P_{1}$ and $P_{2}$ commute, then $P_{1}P_{2}$
is also a projection. This corresponds to the classical intersection
between event. Given a quantum probability measure $\mu$, two projections
$P_{1}$ and $P_{2}$ are independent if $P_{1}$ and $P_{2}$ commute
and $\mu\left(P_{1}P_{2}\right)=\mu\left(P_{1}\right)\mu\left(P_{2}\right)$.
\end{itemize}
\qed\end{definition}
