...
interval $[0,1]$ with intervals of confidence which contain the
probability. The intuition is that the precision of the interval will
depend on the amount of resources allocated for the measurement. 
