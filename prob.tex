...
there is a probability behind each event, and the law of large numbers
promises us a good approximation of the probability if the experiments
run independently and identically for large enough times~\cite{Bernoulli1713,Kolmogorov1950,Uspensky1937,Shafer1976,544199}.
