...
space~\cite{Kolmogorov1950,Shafer1976,Swart2013}
...
\item for mutually orthogonal projections $E_{i}$, we have 
$\mu\left(\tensor*[_{\mathscr{O}}]{\sum}{_{i}}E_{i}\right)=\tensor*[_{\mathbb{R}}]{\sum}{_{i}}\mu\left(E_{i}\right)$.
\end{itemize}
\qed\end{definition}
...
however, $\mu\left(E_{1}\tensor*[_{\mathscr{O}}]{+}{}E_{2}\right)=\mu(E_{1})\tensor*[_{\mathbb{R}}]{+}{}\mu(E_{2})$
...
theorem. However, the definition diverges, and none of them can apply
directly. We may need to check more papers to find the majority or
