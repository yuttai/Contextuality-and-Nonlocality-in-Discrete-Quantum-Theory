...
\item Instead of real-valued probability measures producing results in
  ...
  set-valued probablitity measures~\cite{Artstein1972,PuriRalescu1983}.
\end{itemize}
...
\item given a probability measure $\mu$
  ...
  to a probability, is there is a \emph{unique} state $\psi$
  such that $\mu(E)
  =
...
\amr{The rest is NO NO NO. We are inventing some other conditions on
  probability measures that are not part of the framework !!! }
