...
probability measure]\label{ex:three-dimensional-4-value-2} Given
...
Consider\emph{ }$\mathscr{I}=\left\{ \imposs,\necess,\left[1-2r_{0},r_{0}\right],\left[1-r_{0},2r_{0}\right],\left[2-4r_{0},1-r_{0}\right],\left[r_{0},4r_{0}-1\right]\right\} $.
...
we define 
\begin{eqnarray*}
\bar{\mu}\left(\proj{0_{\theta,\gamma}^{\perp}}\right)=\bar{\mu}\left(\proj{\ps_{\theta,\gamma}^{\perp}}\right) & = & \left[r_{0},4r_{0}-1\right]\\
\bar{\mu}\left(\mathbb{1}\tensor*[_{\mathscr{O}}]{-}{}\proj{0_{\theta,\gamma}^{\perp}}\right)=\bar{\mu}\left(\mathbb{1}\tensor*[_{\mathscr{O}}]{-}{}\proj{\ps_{\theta,\gamma}^{\perp}}\right) & = & \left[2-4r_{0},1-r_{0}\right]\textrm{ .}
\end{eqnarray*}
\item Otherwise, $\bar{\mu}(\proj{\psi})=\left[1-2r_{0},r_{0}\right]$ and
$\bar{\mu}(\mathbb{1}\tensor*[_{\mathscr{O}}]{-}{}\proj{\psi})=\left[1-r_{0},2r_{0}\right]$. 
\end{enumerate}
...
these is always a state~$\ket{\psi}$ such that $\mu_{\rho}^{B}\left(\proj{\psi}\right)\in\bar{\mu}\left(\proj{\psi}\right)=\left[1-2r_{0},r_{0}\right]$,
...
no matter which $b\in\mathbb{R}$, $\rho$ always has a negative eigenvalue.
This contradiction implies $\bar{\mu}$ has an empty core when $r_{0}\in\left(\frac{5+2\sqrt{2}}{17},\frac{1}{2}\right]$.\qed\end{example}
