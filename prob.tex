...
probability measures, like constructing example~\ref{ex3} from example~\ref{ex1}.
In general, this idea can be generalized to the following definition
of core.
...
is correct, or neither proved the theorem we want.

First, \cite{JamisonLodwick2004} shows a kind of equivalence between
interval-valued probability measures and clouds. 

On one hand, a combination of the following two theorems show interval-valued
probability measures is likely to have a core.
...
Verifying the example to see who is right...}
