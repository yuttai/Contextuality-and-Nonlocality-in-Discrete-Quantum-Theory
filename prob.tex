...
of $\bar{\mu}$ is the set~\cite{GilboaSchmeidler1994,Marinacci1999,Teran2014}
\[
...
Second, when $P_{1}=P_{2}+P_{3}$, equation (\ref{eq:QuantumInterval-valuedProbability-Convex})
holds trivially. Hence, we only need to verify the case which $P_{1}=\proj{\psi_{1}}\tensor*[_{\mathscr{O}}]{+}{}\proj{\psi_{3}}$
...
\end{eqnarray*}
and $\left\{ \bar{\mu}\left(P_{1}\right),\bar{\mu}\left(P_{2}\right)\right\} $
is either $\left\{ \bar{\mu}\left(\necess\right),\bar{\mu}\left(\unknown\right)\right\} $
or $\left\{ \bar{\mu}\left(\unknown\right),\bar{\mu}\left(\unknown\right)\right\} $.
Therefore, we have
\[
\bar{\mu}\left(P_{1}\tensor*[_{\mathscr{O}}]{\vee}{}P_{2}\right)\tensor*[_{\mathscr{I}}]{+}{}\bar{\mu}\left(P_{1}P_{2}\right)\subseteq\bar{\mu}\left(P_{1}\right)\tensor*[_{\mathscr{I}}]{+}{}\bar{\mu}\left(P_{2}\right)\textrm{ .}
\]
