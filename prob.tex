...
\frac{1}{2} & = & \mu_{\rho}^{B}\left(\proj{0_{\theta,\gamma}^{\perp}}\right)\\
 ...
 & = & \Tr\left(\sideset{_{\mathscr{O}}}{_{i=0}^{2}}\sum\left(r_{i1}\rme^{\rmi\gamma}\sin\theta\ket{i}+r_{i2}\cos\theta\ket{i}\right)\left(\rme^{-\rmi\gamma}\sin\theta\bra{1}+\cos\theta\bra{2}\right)\right)\\
...
and $0\le\gamma<\pi$, we must have $r_{12}=r_{21}=0$ and $r_{11}=r_{22}=\frac{1}{2}$.\qed\end{example}
\end{document}
