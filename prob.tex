...
Given a Hilbert space $\Hilb$, an event\footnote{An event is formally called an experimental proposition~\cite{BirkhoffVonNeumann1936},
a question~\cite{10.2307/2308516}, or an elementary quantum test~\cite{peres1995quantum}} mathematically is represented as a projection operator
