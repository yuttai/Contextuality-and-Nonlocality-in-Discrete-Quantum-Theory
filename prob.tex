...
\yutsung{Vourdas' first paper~\cite{Vourdas2014} is interesting
and highly readable until section IV. In particular, the comparison
between the Kolmogorov's
\[
\delta\left(A,B\right)=q\left(A\vee B\right)-q\left(A\right)-q\left(B\right)+q\left(A\wedge B\right)
\]
where $A$ and $B$ are events, and $q\left(A\right)$ is the probability
of $A$; and its quantum counterpart 
\[
\mathfrak{D}\left(H_{1},H_{2}\right)=\mathfrak{P}\left(H_{1}\vee H_{2}\right)-\mathfrak{P}\left(H_{1}\right)-\mathfrak{P}\left(H_{2}\right)+\mathfrak{P}\left(H_{1}\wedge H_{2}\right)
\]
...
Start reading \cite{Vourdas2015}...}
