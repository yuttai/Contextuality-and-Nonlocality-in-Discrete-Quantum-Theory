...
is convex if $\bar{\mu}\left(E_{1}\cup E_{2}\right)\tensor*[_{\mathscr{I}}]{+}{}\bar{\mu}\left(E_{1}\cap E_{2}\right)\ge\bar{\mu}\left(E_{1}\right)\tensor*[_{\mathscr{I}}]{+}{}\bar{\mu}\left(E_{2}\right)$
for all $E_{1},E_{2}\in\events$.\qed\end{thm}

In particular, Dempster-Shafer probability measures are all convex
and have nonempty cores. 

It seems general interval-valued probability measures must have a
core. Following are proving plan: 
...
Next need to verify every interval-valued probability measures must
define a cloud...}
