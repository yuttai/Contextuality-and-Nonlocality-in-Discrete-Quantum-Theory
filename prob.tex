...
An interval-valued probability measure can satisfy extra conditions.
It is called \emph{convex} or \emph{2-monotone} if $\bar{\mu}\left(E_{1}\cup E_{2}\right)\tensor*[_{\mathscr{I}}]{+}{}\bar{\mu}\left(E_{1}\cap E_{2}\right)\subseteq\bar{\mu}\left(E_{1}\right)\tensor*[_{\mathscr{I}}]{+}{}\bar{\mu}\left(E_{2}\right)$
for all $E_{1},E_{2}\in\events$~\cite{Shapley1965,GilboaSchmeidler1994,Marinacci1999,Teran2014}.
...
an important role in the theory of non-additive belief~\cite{Dempster1967,Shafer1976,GilboaSchmeidler1994,Marinacci1999,Goodman2013,Teran2014}.\footnote{\yutsung{If we want to use convex, we need to explain the physical
meaning of convex interval-valued probability measures...?}}
...
\ref{ex3} can be abstracted into the definition of core.
...
Then, a wide variety of interval-valued probability measures can be
associated with real-valued probability measures.
...
\end{equation}
\footnote{$\bar{\mu}$ is called convex if $\bar{\mu}\left(P_{1}\tensor*[_{\mathscr{O}}]{\vee}{}P_{2}\right)\tensor*[_{\mathscr{I}}]{+}{}\bar{\mu}\left(P_{1}P_{2}\right)\ge\bar{\mu}\left(P_{1}\right)\tensor*[_{\mathscr{I}}]{+}{}\bar{\mu}\left(P_{2}\right)$
...
When a quantum interval-valued probability measure~$\bar{\mu}:\events\rightarrow\mathscr{I}$
constructed from a real-valued one~$\mu:\events\rightarrow\left[0,1\right]$,
we should say $\mu$ is in the core of $\bar{\mu}$ according to the
following definition of core.

\begin{definition}[Core of Quantum Interval-valued Probability
Measure]\label{def:CoreQuantumInterval-valuedProbability} A \emph{core}
of a quantum interval-valued probability measure~$\bar{\mu}:\events\rightarrow\mathscr{I}$
is the set 
\[
