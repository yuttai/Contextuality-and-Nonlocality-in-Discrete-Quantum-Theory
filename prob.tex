...
$x_{i}$ denote whether the event~$E$ occurs in the $i$-th trial
or not, then $\pmeas(E)$ could be approximated to given accuracy
...
\item for every collection of pairwise disjoint events $\left\{ E_{i}\right\} ,\left\{ E_{i}'\right\} \subseteq\events$
with $\Omega=\left(\bigcup_{i}E_{i}\right)\bigcup\left(\bigcup_{i}E_{i}'\right)$,
we have 
\[
\bar{\mu}\left(\bigcup_{i}E_{i}\right)\subseteq\left[\max\left\{ 1-\sideset{_{\mathbb{R}}}{_{i}}\sum r_{i}',\sideset{_{\mathbb{R}}}{_{i}}\sum l_{i}\right\} ,\min\left\{ 1-\sideset{_{\mathbb{R}}}{_{i}}\sum l_{i}',\sideset{_{\mathbb{R}}}{_{i}}\sum r_{i}\right\} \right]\textrm{ ,}
\]
...
\item $\bar{\mu}(\emptyset)=[0,0]$, 
\item $\bar{\mu}(\Omega)=[1,1]$, 
\item for any event $E$, $\bar{\mu}\left(\Omega\backslash E\right)=1\tensor*[_{\mathscr{I}}]{-}{}\bar{\mu}\left(E\right)$,
and 
...
\end{cases}
\]
$\iota$ has two interesting properties $\iota\left(\mathbb{1}\tensor*[_{\mathbb{R}}]{-}{}x\right)=1\tensor*[_{\mathscr{I}}]{-}{}\iota\left(x\right)$
