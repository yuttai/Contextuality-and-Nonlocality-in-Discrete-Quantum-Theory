...
Here we want to follow \cite{RichmanBridges1999} to prove under suitable
conditions when intervals are more precise, its quantum interval-valued
probability measures are closer to the Born rule. We will focus on
three dimensional Hilbert space, since 
...
called an \emph{approximation frame function} of weight~$\left(\underline{W},\overline{W}\right)$
if 
\[
\underline{W}\le\tensor*[_{\mathbb{R}}]{\sum}{_{i=0}^{d-1}}f\left(\ket{\psi_{i}}\right)\le\overline{W}
\]
...
is a frame function of weight~$\left(\underline{W},\overline{W}\right)$,
