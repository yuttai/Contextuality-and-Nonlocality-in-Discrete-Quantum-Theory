...
\item Consider the states orthogonal to $\ket{0}$ and $\ket{\ps}$, $\ket{0_{\theta,\gamma}^{\perp}}=\rme^{\rmi\gamma}\sin\theta\ket{1}+\cos\theta\ket{2}$
...
holds.
\item The next simplest case is $\ket{0}\notin\mathcal{B}$, $\ket{\ps}\notin\mathcal{B}$,
...
case. Then, equation (\ref{eq:non-additive-vectors}) can only be
verified once. 
\begin{eqnarray*}
...
\end{eqnarray*}
\item When $\ket{0}\notin\mathcal{B}$ and $\ket{0_{\theta,\gamma}^{\perp}}\in\mathcal{B}$
for $0\le\theta<\frac{\pi}{2}$ and $0\le\gamma<\pi$, we want to
prove $\ket{\ps}\notin\mathcal{B}$ and $\ket{\ps_{\theta,\gamma}^{\perp}}\notin\mathcal{B}$
for $0\le\theta<\frac{\pi}{2}$ and $0\le\gamma<\pi$. Therefore,
let $\ket{\psi_{1}}=\ket{0_{\theta,\gamma}^{\perp}}$ and arbitrary
$\ket{\psi_{2}}$ and $\ket{\psi_{3}}$, we have
\begin{eqnarray*}
