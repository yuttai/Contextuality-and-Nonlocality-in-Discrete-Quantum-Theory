...
(like \emph{$\mathscr{I}=\left\{ \necess,\imposs,\unknown\right\} $}
is too small...) to by-pass the counterexample corresponding to example~\ref{ex:three-dimensional-three-value}.
...
Might be hard, because let $\mu\otimes\mu$ is not a quantum real-valued
