...
$\Omega$ is $2^\Omega$, the power set of $\Omega$. In other words,
...
\end{itemize}
As the examples illustrate, events are \emph{indirect} questions. Also
...
the first coin with sample space, the probability of either outcome
$H$ or $T$ is $\frac{1}/{2}$; for coin two, the probabilities are
skewed a little with the probability of outcome $H$ being
$\frac{2}{5}$ and the probability of outcome $T$ being $\frac{3}{5}$;
coin 3 is a fake double-headed coin and hence the probability of
...
setting. Following previous work on probability, we will replace the
...
A set-valued probability mesure $\mathbb{P} : \mathcal{F} \rightarrow
