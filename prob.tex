...
no information. For any Hilbert space, consider $\mu:\events\rightarrow\mathscr{I}$
defined as follow: 
\[
\mu(E)=\begin{cases}
\necess & \textrm{, if }E=\mathbb{1}\textrm{ ;}\\
\imposs & \textrm{, if }E=\mathbb{0}\textrm{ ;}\\
\unknown & \textrm{, otherwise.}
\end{cases}
\]
It is easy to verify $\mu$ is a quantum interval-valued probability
measure.\qed\end{example}
