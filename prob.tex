...
\end{equation}
We may verify our previous examples. When events are orthogonal and
commutative, they can be measured together and their probability is
additive: 
\[
\mu_{0}(\proj{0})+\mu_{0}(\proj{1})=\mu_{0}(\proj{+})+\mu_{0}(\proj{-})=1=\mu_{0}(\mathbb{1})\textrm{ .}
\]
On the other hand, $\proj{0}$ and $\proj{-}$ are non-commutative,
and their total probabilities are not a probability of an event
\begin{eqnarray*}
