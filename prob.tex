...
\begin{definition}[Projection Operators; Orthogonality; Commutativity]
  Given a Hilbert space $\Hilb$, a projection operator $P$ is a linear
  transformation from $\Hilb$ to itself such that $P^2 = P$. An
  orthogonal projection furthermore satisfies $P = P^*$. Projection
...
\item Projection operators $P_1$ and $P_2$ commute if $P_1P_2 =
  P_2P_1$;
\item If the projections $P_1$ and $P_2$ are orthogonal then f $P_1 +
