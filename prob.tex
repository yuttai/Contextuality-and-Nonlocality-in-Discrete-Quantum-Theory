...
\begin{equation}
\mu_{\psi}(E)=\frac{\ip{\psi}{E\psi}}{\ip{\psi}{\psi}}\label{eq:Born}
\end{equation}
...
Born rule (\ref{eq:Born})~\cite{Born1984,Mermin2007}; 
...
and consider variations motivated by computation of numerical quantities
in a world with limited resources. In particular, we will consider
a variant of the Hilbert space over finite fields~$\mathbb{F}_{p^{2}}^{d}$~\cite{HansonOrtizSabryEtAl2015,DQT2014,geometry2013}.
...
is an open interval, $\left(0,\infty\right)$. 
