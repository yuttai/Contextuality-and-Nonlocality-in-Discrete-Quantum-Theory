...
\]
\yutsung{If we want to follow Swart~\cite{Swart2013}... Maybe we
should define the set of projection and the }\\
Each state $\psi$ of the Hilbert space induces a probability measure
$\phi_\psi : \qevents \rightarrow [0,1]$ defined as follows:
\[
\phi_\psi(A) = \langle \psi ~|~ A\psi \rangle
\]
