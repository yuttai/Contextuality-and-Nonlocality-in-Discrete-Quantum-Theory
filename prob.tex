...
set~$\left\{ E_{i}\right\} _{i=1}^{N}$, we have $\tensor*[_{\mathbb{R}}]{\sum}{_{i=1}^{N}}\gamma_{i}l\left(E_{i}\right)\le1$,
where $\left\{ E_{i}\right\} _{i=1}^{N}$ is called minimal balanced
set if they are distinct, $\emptyset\ne E_{i}\subsetneq\Omega$, and
there exist a unique positive coefficient~$\left\{ \gamma_{i}\right\} _{i=1}^{N}$
...
an algorithm~\cite{Peleg1965}. However, the number of minimal balanced
sets grows very rapidly with the size of $\Omega$, $\left|\Omega\right|$,
