...
In this case, we split the $[0,1]$ interval into a collection of
overlapping closed sub-intervals obeying certain restrictions to be
described at the end of the section. First we illustrate the main
ideas using a simple example.
