...
A special feature of this theory is that it discusses the relation
between non-commuting subspaces while the real-valued quantum probability
measures in definition~\ref{def:QuantumProbabilitySpace} only depend
on orthogonal (or commuting) subspaces. Thinking a physical process
which put two non-commuting spaces together... Maybe two directions
of the first spin in the two-spin system?
