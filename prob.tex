...
\begin{itemize}
\item \url{http://cds.cern.ch/record/518511/files/0107054.pdf} \cite{GranikCaulfield2001}\\
\yutsung{The journal didn't put the given volume online... Add arXiv
version as well, and request an inter-librarian loan...}
...
\cite{Gudder2005}\\
\yutsung{Cannot get the published version online. Request an inter-librarian
loan.}
\item \url{http://www.space-lab.ru/files/pages/PIRT_VII-XII/pages/text/PIRT_X/Bobola.pdf}
\\
\yutsung{Doesn't find this paper anywhere else except in this URL...
It seems that it doesn't appear in author's homepage, and I am not
sure if I found their institution's web page... Very strange...}
\item \url{http://www.vub.ac.be/CLEA/aerts/publications/1993LiptovskyJan.pdf}
\cite{aerts1993physical}
\item \cite{RiecanNeubrunn1997}\\
\yutsung{Might related. Get this book when I google ``Fuzzy Gleason's
Theorem''...}
\end{itemize}
...
with a specified amount of computing resources.'' \cite{BlumMicali1984}
\item Another version \url{https://pdfs.semanticscholar.org/3e9c/5f6f48d9ef426655dc799e9b287d754e86c1.pdf} 
\end{itemize}
\noindent Quantum bayesianism and QBism: 
\begin{itemize}
\item \cite{Fuchs2010}
\item \cite{VonBaeyer2016}
\end{itemize}
%%%%%
...
about $\ket{\psi}$. More explicitly, for any vector~$\ket{\phi}\in\mathbb{R}S^{2}$,
