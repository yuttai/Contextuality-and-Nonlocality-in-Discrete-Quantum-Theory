...
So\footnote{\yutsung{Verify the details...}} 
\begin{eqnarray*}
 &  & \left|f'\left(\ket{\psi}\right)+f'\left(\sigma_{\ket{0},\frac{\pi}{2}}\ket{\psi}\right)\right|\\
 & = & \left|\left(f\left(\ket{\psi}\right)+f\left(\sigma_{\ket{0},\frac{\pi}{2}}\ket{\psi}\right)\right)-\left(Q\left(\ket{\psi}\right)+Q\left(\sigma_{\ket{0},\frac{\pi}{2}}\ket{\psi}\right)\right)\right|\\
 & = & \left|g_{f,\ket{0}}-\left(Q\left(\ket{\psi}\right)+Q\left(\sigma_{\ket{0},\frac{\pi}{2}}\ket{\psi}\right)\right)\right|
\end{eqnarray*}
\end{proof}
