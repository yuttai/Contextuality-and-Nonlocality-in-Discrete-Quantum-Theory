...
\NewDocumentEnvironment{compareText}{m m}{\noindent\begin{minipage}[b]{1\columnwidth}#1{The following is #2 text.}\begin{docParinfo}}{\end{docParinfo}#1{The #2 text end here.}\end{minipage}}
\newenvironment{oldText}[1]{\begin{compareText}{#1}{old}}{\end{compareText}\penalty-10000}
