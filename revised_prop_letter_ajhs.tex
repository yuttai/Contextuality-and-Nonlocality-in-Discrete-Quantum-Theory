...
The above arguments could be summarized and illustrated using
...
Meyer's insight and the main assumption in his proof that using the
field of rationals nullifies the Kochen-Specker theorem.  In other
