...
{\color{red}An outline of}The proof, detailed in the forthcoming
...
\subsection{\color{red}Finite-Precision Extension of Gleason's Theorem}
...
\subsection{\color{red}Ultramodular Functions}
