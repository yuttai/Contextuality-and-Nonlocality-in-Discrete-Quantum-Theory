...
two simple lemmas {\color{red}that} we present first. 
...
If this is true, then {\color{red}$\ip{0}{\phi_{j}}=\ip{\ps}{\phi_{j}}=\ip{\ps'}{\phi_{j}}=0$
for all~$j$, and thus
\begin{subequations}
\begin{eqnarray}
...
To that end, we {\color{red}introduce the concept of \emph{interval maps}, which
...
{\color{red}(this should not be confused with
...
{\color{red} For any given Hermitian operator~$A$, we choose the}
...
the following properties{\color{red}:}
...
\]
The induced map {\color{red}$\ultramodular\circ\muB_{\rho}$ constructed using the Born rule and
