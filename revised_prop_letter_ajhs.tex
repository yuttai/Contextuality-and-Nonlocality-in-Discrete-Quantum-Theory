...
\newInterval[\imposs][impossible][0,0]
\newInterval[\likely][likely][\tfrac{1}{2},1]
\newInterval[\unlikely][unlikely][0,\tfrac{1}{2}]
\newInterval[\necess][certain][1,1]
\newInterval[\unknown][unknown][0,1]
\newInterval[\midd][middle][\tfrac{1}{4},\tfrac{3}{4}]
